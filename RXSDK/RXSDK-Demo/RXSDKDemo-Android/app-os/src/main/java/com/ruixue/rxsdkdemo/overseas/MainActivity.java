...
public class MainActivity extends AppCompatActivity {
    ...
    // 国内版包名
    private static final String DOMESTIC_PACKAGE = "com.ruixue.rxsdkdemo";

    /**
     * 环境按钮点击
     */
    private void onEnvClicked(int env) {
        if (env == RXSDKManager.ENV_DOMESTIC) {
            // 点击国内按钮，跳转到国内版 app
            launchAppByPackage(DOMESTIC_PACKAGE);
            return;
        }
        
        // 当前已是海外版，点击海外按钮无需处理
        Toast.makeText(this, "当前已是海外版", Toast.LENGTH_SHORT).show();
    }
    ...
    private void launchAppByPackage(String packageName) {
        ...
        if (intent != null) {
            ...
            Toast.makeText(this, "未安装国内版Demo应用", Toast.LENGTH_SHORT).show();
        }
    }
