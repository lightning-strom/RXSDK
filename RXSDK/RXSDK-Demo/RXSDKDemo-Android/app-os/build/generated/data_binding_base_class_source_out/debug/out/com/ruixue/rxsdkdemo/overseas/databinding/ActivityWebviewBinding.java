...
public final class ActivityWebviewBinding implements ViewBinding {
  ...
  private ActivityWebviewBinding(@NonNull LinearLayout rootView, @NonNull ImageButton btnBack,
      @NonNull Button btnGo, @NonNull ImageButton btnRefresh, @NonNull EditText etUrl,
      @NonNull ProgressBar progressBar, @NonNull TextView tvTitle, @NonNull WebView webView) {
  ...
  public static ActivityWebviewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityWebviewBinding((LinearLayout) rootView, btnBack, btnGo, btnRefresh, etUrl,
