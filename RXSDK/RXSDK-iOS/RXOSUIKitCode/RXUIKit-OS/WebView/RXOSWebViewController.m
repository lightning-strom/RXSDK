...
@interface RXOSWebViewController () <WKNavigationDelegate, WKUIDelegate>
...
@implementation RXOSWebViewController
...
- (void)webView:(WKWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler {
    ...
    if (navigationAction.navigationType == WKNavigationTypeLinkActivated) {
        // 通过浏览器访问
        RXOSWebViewController *webVC = [[RXOSWebViewController alloc] init];
...
//    .heightIs(self.orientation == 2 ? 60 : kRXNavigationAndStatusHeight);
    ...
    [closeBtn setImage:[UIImage rxOSBundleImageNamed:@"close"] forState:UIControlStateNormal];
...
- (void)setCookie
{
    ...
    NSString *jsonStr2 = [RXOSCommonTool getJsonString:[RXOSUserUtility sharedManager].loginData];
