...
@implementation UIImage (RXOSAddition)

+ (UIImage *)rxOSBundleImageNamed:(NSString *)imageName
{
    NSBundle *bundle = [NSBundle bundleForClass:[RXOSUIKitService class]];
    NSURL *url = [bundle URLForResource:@"RXOSUIKit" withExtension:@"bundle"];
