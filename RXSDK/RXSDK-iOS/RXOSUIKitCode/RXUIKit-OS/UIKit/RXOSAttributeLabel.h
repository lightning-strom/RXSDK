...
@protocol RXOSAttributeLabelDelegate <NSObject>

- (void)rxAttributeClick:(NSString *)text;

@end

@interface RXOSAttributeLabel : UIView
...
@property (nonatomic, weak) id <RXOSAttributeLabelDelegate> delegate;
