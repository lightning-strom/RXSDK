...
@interface RXOSAnnouncementView ()<UITableViewDelegate, UITableViewDataSource, WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler>
...
@implementation RXOSAnnouncementView
...
//        [[UIApplication sharedApplication].keyWindow addSubview:self];
        ...
        if (tempTitle.length == 0) {
            tempTitle = [RXLocation osLaunguage:@"维护公告"];
        }else{
            tempTitle = title;
        }
...
- (void)layoutViews{
    ...
    if (RXAC) {
        self.bgView.frame = CGRectMake(0, 0, RXUScaleWidth(480), RXUScaleWidth(276));
        ...
        self.bgTopView.frame = CGRectMake(0, 0, self.bgView.frame.size.width, RXUScaleWidth(62));
        
        if (RXOSCommonTool.isRTL) {
            self.callBoardLabel.textAlignment = NSTextAlignmentRight;
            self.callBoardLabel.frame = CGRectMake(bgViewWidth - 20 - RXUScaleWidth(200), RXUScaleWidth(21), RXUScaleWidth(200), RXUScaleWidth(20));
            self.titleLabel.textAlignment = NSTextAlignmentRight;
//            self.tipLable.frame = CGRectMake(bgViewWidth - 20 - RXUScaleWidth(150), CGRectGetMaxY(self.callBoardLabel.frame), RXUScaleWidth(150), RXUScaleWidth(12));
//            self.tipLable.textAlignment = NSTextAlignmentRight;
            self.imageView.frame = CGRectMake(RXUScaleWidth(63), -20, 100, 100);
            self.closeBtn.frame = CGRectMake(24, (RXUScaleWidth(63) - RXUScaleWidth(25))/2, RXUScaleWidth(25), RXUScaleWidth(25));
            
            if (self.count == 1) {//单个邮件
                self.tableView.hidden = YES;
                float titleHeight = [self.currentDic[@"title"] heightForFont:[UIFont boldSystemFontOfSize:RXUScaleWidth(14)] width:bgViewWidth - 16 - 16];
                ...
                self.tableView.frame = CGRectMake(bgViewWidth - 16 - RXUScaleWidth(112), self.bgTopView.frame.size.height + 10, RXUScaleWidth(112), bgViewHeight - self.bgTopView.frame.size.height - 10 - 5);
                float titleHeight = [self.currentDic[@"title"] heightForFont:[UIFont boldSystemFontOfSize:RXUScaleWidth(14)] width:bgViewWidth - 16 - self.tableView.frame.size.width - 16 - 16];
                self.titleLabel.frame = CGRectMake(16, self.bgTopView.frame.size.height + 10, bgViewWidth - 16 - self.tableView.frame.size.width - 16 - 16, titleHeight);
                self.titleLabel.textAlignment = NSTextAlignmentRight;
                self.wkWebview.frame = CGRectMake(16, CGRectGetMaxY(self.titleLabel.frame) + 10, bgViewWidth - 16 - self.tableView.frame.size.width - 16 - 16, bgViewHeight - self.bgTopView.frame.size.height - 10 - titleHeight - 10 - 5);
            }
            
        }else{
            self.callBoardLabel.textAlignment = NSTextAlignmentLeft;
            self.callBoardLabel.frame = CGRectMake(20, RXUScaleWidth(21), RXUScaleWidth(200), RXUScaleWidth(20));
            self.titleLabel.textAlignment = NSTextAlignmentLeft;
//            self.tipLable.frame = CGRectMake(20, CGRectGetMaxY(self.callBoardLabel.frame), RXUScaleWidth(150), RXUScaleWidth(12));
//            self.tipLable.textAlignment = NSTextAlignmentLeft;
            self.imageView.frame = CGRectMake(bgViewWidth - RXUScaleWidth(63) - 100, -20, 100, 100);
            self.closeBtn.frame = CGRectMake(bgViewWidth - 24 - RXUScaleWidth(25), (RXUScaleWidth(63) - RXUScaleWidth(25))/2, RXUScaleWidth(25), RXUScaleWidth(25));
            ...
            if (self.count == 1) {//单个邮件
                ...
                self.tableView.hidden = NO;
                self.tableView.frame = CGRectMake(16, self.bgTopView.frame.size.height + 10, RXUScaleWidth(112), bgViewHeight - self.bgTopView.frame.size.height - 10 - 5);
                float titleHeight = [self.currentDic[@"title"] heightForFont:[UIFont boldSystemFontOfSize:RXUScaleWidth(14)] width:bgViewWidth - 16 - self.tableView.frame.size.width - 16 - 16];
        ...
        self.bgView.frame = CGRectMake(0, 0, RXUScaleWidth(303), RXUScaleWidth(333));
        self.bgView.center = window.center;
        CGFloat bgViewWidth = self.bgView.frame.size.width;
        CGFloat bgViewHeight = self.bgView.frame.size.height;
        
        self.bgTopView.frame = CGRectMake(0, 0, bgViewWidth, RXUScaleWidth(62));
...
//            self.tipLable.frame = CGRectMake(bgViewWidth - 20 - RXUScaleWidth(150), CGRectGetMaxY(self.callBoardLabel.frame), RXUScaleWidth(150), RXUScaleWidth(12));
//            self.tipLable.textAlignment = NSTextAlignmentRight;
            self.imageView.frame = CGRectMake(RXUScaleWidth(54), -8, 78, 78);
            self.closeBtn.frame = CGRectMake(24, (RXUScaleWidth(63) - RXUScaleWidth(25))/2, RXUScaleWidth(25), RXUScaleWidth(25));
            
            if (self.count == 1) {
                self.tableView.hidden = YES;
                float titleHeight = [self.currentDic[@"title"] heightForFont:[UIFont boldSystemFontOfSize:RXUScaleWidth(14)] width:bgViewWidth - 12 - 12];
                ...
                self.tableView.hidden = NO;
                self.tableView.frame = CGRectMake(bgViewWidth - 12 - RXUScaleWidth(94), self.bgTopView.frame.size.height + 10, RXUScaleWidth(94), bgViewHeight - self.bgTopView.frame.size.height - 10 - 10);
                float titleHeight = [self.currentDic[@"title"] heightForFont:[UIFont boldSystemFontOfSize:RXUScaleWidth(14)] width:bgViewWidth - 12 - self.tableView.frame.size.width - 8 - 12];
                self.titleLabel.frame = CGRectMake(16, self.bgTopView.frame.size.height + 10, bgViewWidth - 12 - self.tableView.frame.size.width - 8 - 12, titleHeight);
                self.titleLabel.textAlignment = NSTextAlignmentRight;
                self.wkWebview.frame = CGRectMake(16, CGRectGetMaxY(self.titleLabel.frame) + 6, bgViewWidth - 12 - self.tableView.frame.size.width - 8 - 12, bgViewHeight - self.bgTopView.frame.size.height - 10 - titleHeight - 6 - 10);
            }
...
//            self.tipLable.frame = CGRectMake(20, CGRectGetMaxY(self.callBoardLabel.frame), RXUScaleWidth(150), RXUScaleWidth(12));
//            self.tipLable.textAlignment = NSTextAlignmentLeft;
            self.imageView.frame = CGRectMake(bgViewWidth - RXUScaleWidth(54) - 78, -8, 78, 78);
            self.closeBtn.frame = CGRectMake(bgViewWidth - 24 - RXUScaleWidth(25), (RXUScaleWidth(63) - RXUScaleWidth(25))/2, RXUScaleWidth(25), RXUScaleWidth(25));
            ...
            if (self.count == 1) {
                ...
                self.tableView.hidden = NO;
                self.tableView.frame = CGRectMake(12, self.bgTopView.frame.size.height + 10, RXUScaleWidth(94), bgViewHeight - self.bgTopView.frame.size.height - 10 - 10);
                float titleHeight = [self.currentDic[@"title"] heightForFont:[UIFont boldSystemFontOfSize:RXUScaleWidth(14)] width:bgViewWidth - 12 - self.tableView.frame.size.width - 8 - 12];
...
#pragma mark - 获取所有图片地址，并添加点击手势
    [self addImgClickJS];
#pragma mark - RTL展示居右展示文字
    if (RXOSCommonTool.isRTL) {
        NSString *source = @"var style = document.createElement('style'); style.innerHTML = 'body { text-align: right; }'; document.head.appendChild(style);";
        [webView evaluateJavaScript:source completionHandler:nil];
    }else{
        NSString *source = @"var style = document.createElement('style'); style.innerHTML = 'body { text-align: left; }'; document.head.appendChild(style);";
        [webView evaluateJavaScript:source completionHandler:nil];
    }
}
...
{
    return RXUScaleWidth(46);
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    RXOSAnnouncementTitleCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell"];
    if (!cell) {
        cell = [[RXOSAnnouncementTitleCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"];
    }
...
- (UILabel *)callBoardLabel{
    if (!_callBoardLabel) {
        ...
        _callBoardLabel.font = [UIFont boldSystemFontOfSize:RXUScaleWidth(16)];
        _callBoardLabel.text = [RXLocation osLaunguage:@"公告板"];
    }
...
//        _tipLable.font = [UIFont systemFontOfSize:RXUScaleWidth(12)];
...
- (UIImageView *)imageView{
    if (!_imageView) {
        ...
        _imageView.image = [UIImage rxOSBundleImageNamed:@"rx_announce"];
    }
    return _imageView;
}
