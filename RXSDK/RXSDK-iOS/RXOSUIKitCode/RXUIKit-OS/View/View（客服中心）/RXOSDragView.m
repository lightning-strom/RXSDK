...
- (instancetype)initWithFrame:(CGRect)frame vc:(UIViewController *)vc {
    if (self = [super initWithFrame:frame]) {
        ...
        _clickImgView.image = [UIImage rxOSBundleImageNamed:@"rx_service_minimized"];
        ...
        _redTip.image = [UIImage rxOSBundleImageNamed:@"rx_service_red"];
        _redTip.hidden = YES;
