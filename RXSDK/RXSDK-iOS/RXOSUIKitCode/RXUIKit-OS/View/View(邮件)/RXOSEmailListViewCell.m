...
@implementation RXOSEmailListViewCell
...
- (void)setupSubviews {
    ...
    if (RXAC) {
        if ([RXOSCommonTool isRTL]) {
            self.customImageView.frame = CGRectMake((RXUScaleWidth(531) - 24) - 14 - RXUScaleWidth(16), RXUScaleWidth(11), RXUScaleWidth(16), RXUScaleWidth(14));
            
            self.titleLabel.frame = CGRectMake(RXUScaleWidth(100) + 14, 0, (RXUScaleWidth(531) - 24) - 28 - RXUScaleWidth(16) - 24 - RXUScaleWidth(100), 36);
            
            self.timeLabel.textAlignment = NSTextAlignmentLeft;
            self.timeLabel.frame = CGRectMake(14, 0, RXUScaleWidth(100), RXUScaleWidth(36));
        }else{
        ...
        if ([RXOSCommonTool isRTL]) {
            self.customImageView.frame = CGRectMake((RXUScaleWidth(313) - 20) - 10 - RXUScaleWidth(16), RXUScaleWidth(11), RXUScaleWidth(16), RXUScaleWidth(14));
            
            self.titleLabel.frame = CGRectMake(self.customImageView.frame.origin.x - 8 - ((RXUScaleWidth(313) - 20) - 20 - 16 - RXUScaleWidth(16) - RXUScaleWidth(100)), 0, ((RXUScaleWidth(313) - 20) - 20 - 16 - RXUScaleWidth(16) - RXUScaleWidth(100)), RXUScaleWidth(36));
            
            self.timeLabel.textAlignment = NSTextAlignmentLeft;
            self.timeLabel.frame = CGRectMake(10, 0, RXUScaleWidth(100), RXUScaleWidth(36));
        }else{
...
- (UIImageView *)customImageView{
    if (!_customImageView) {
        ...
        _customImageView.image = [UIImage rxOSBundleImageNamed:@"rx_mailUnRead"];
    }
