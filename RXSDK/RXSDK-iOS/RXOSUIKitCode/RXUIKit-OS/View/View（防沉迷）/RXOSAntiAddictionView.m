...
@interface RXOSAntiAddictionView ()
...
@implementation RXOSAntiAddictionView
...
- (void)layoutViews
{
    ...
    // 文字高度
    CGFloat desH = [self.desStr heightForFont:_desLbl.font width:[RXOSCommonTool getScreenWidth]] + 22;
    CGFloat bgH = desH + 142;
    ...
    _desLbl.frame = CGRectMake(RXAC ? 29 : 25, CGRectGetMaxY(_titleLbl.frame) + 8, CGRectGetWidth(_bgView.frame) - (RXAC ? 58 : 50), desH);
