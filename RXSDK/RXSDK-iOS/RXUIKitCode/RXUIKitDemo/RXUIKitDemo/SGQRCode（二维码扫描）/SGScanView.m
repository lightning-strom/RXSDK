...
//        [self addSubview:self.contentView];
        [self addSubview:self.scanImageV];
    }
    return self;
}
...
{
    if (!_scanImageV) {
        _scanImageV = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"qrcode_scan"]];
        _scanImageV.frame = CGRectMake(scanBorderX, scanBorderY, scanBorderW, scanBorderW);
        _scanImageV.backgroundColor = [UIColor clearColor];
    }
    return _scanImageV;
}
...
//        [_contentView addSubview:self.scanningline];
        [_scanImageV addSubview:self.scanningline];
