...
//            [[RXService sharedSDK] loginWithLoginType:LoginTypeVisitor username:@"" password:@"" captchaCode:@"" loginOpenId:@"" extDic:nil signFields:nil migrateArgs:nil];
        ...
        case 53: {// 查询角色列表
            [[RXApiService sharedSDK] searchGameCharacterListInfoWithCpUserId:@"cpUserId" complete:^(NSDictionary * _Nullable response, RX_CommonRequestError * _Nullable error) {
                NSLog(@"");
            }];
            break;
        }
