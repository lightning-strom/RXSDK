...
@interface RXInsideWebView () <WKNavigationDelegate, WKUIDelegate>
...
@implementation RXInsideWebView
...
- (void)userContentController:(WKUserContentController *)userContentController didReceiveScriptMessage:(WKScriptMessage *)message {
    ...
    [RXInsideWebViewManager sharedSDK].complete = self.complete;
