...
@interface RXSetPasswordView () <UITextFieldDelegate, UITextViewDelegate>
...
@implementation RXSetPasswordView
...
- (void)confimBtnAction
{
    ...
    if (![RXUICommonTool checkPasswordWithPwd:self.passwordTF.tf.text]) {
...
//            msg = @"请输入密码";
//        }
        _passwordTF = [[RXTextField alloc] initWithPlaceholder:msg type:TFType_pwdNormal keyboardType:UIKeyboardTypeDefault];
...
{
    if (!_passwordTF1) {
        _passwordTF1 = [[RXTextField alloc] initWithPlaceholder:@"请再次输入您的密码" type:TFType_pwdNormal keyboardType:UIKeyboardTypeDefault];
