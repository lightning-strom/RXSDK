...
@interface RXAnnouncementTitleCell ()

@property (nonatomic, strong) UIView *topView;
@property (nonatomic, strong) RXAnnouncementTitleLabel *titleLabel;
@property (nonatomic, strong) UIView *badgeView;
@property (nonatomic, strong) UIView *lineView;

@end

@implementation RXAnnouncementTitleCell
...
- (void)layoutSubviews{
    ...
    self.badgeView.frame = CGRectMake(cellWidth - 8, 0, 8, 8);
}
...
- (UILabel *)titleLabel{
    if (!_titleLabel) {
        _titleLabel = [[RXAnnouncementTitleLabel alloc] init];
