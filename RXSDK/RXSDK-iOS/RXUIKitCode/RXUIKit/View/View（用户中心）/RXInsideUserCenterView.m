...
@interface RXInsideUserCenterView ()
...
@implementation RXInsideUserCenterView
...
//    _changeBtn.frame = CGRectMake(CGRectGetMinX(_bgView.frame) + (RXAC ? 485 : 242), CGRectGetMinY(_bgView.frame) + (RXAC ? 73 : 83), RXAC ? 142 : 115, RXAC ? 44 : 36);
    ...
    if (!_webView) {
        ...
        _webView = [[RXInsideWebView alloc] initWithFrame:CGRectMake(CGRectGetMinX(_bgView.frame) + (RXAC ? 19 : 16), CGRectGetMinY(_bgView.frame) + (RXAC ? 116 : 112), CGRectGetWidth(_bgView.frame) - (RXAC ? 38 : 32), RXAC ? 171 : 181)];
