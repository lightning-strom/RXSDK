 ...
 */
typedef void(^RXTTAutoTrackLogger)(NSString * _Nullable log);
 ...
 */
typedef NS_ENUM(NSInteger, RXTTAutoTrackServiceVendor) {
    RXTTAutoTrackServiceVendorCN = 0x010, // 国内 中国
    RXTTAutoTrackServiceVendorSG,         // 新加坡
    RXTTAutoTrackServiceVendorVA,         // 美东
};

NS_ASSUME_NONNULL_BEGIN

@interface RXTTConfig : NSObject
 ...
 */
@property (nonatomic, assign) RXTTAutoTrackServiceVendor serviceVendor;
 ...
 */
@property (nonatomic, copy, nullable) RXTTAutoTrackLogger logger;
