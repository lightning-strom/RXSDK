...
@interface RXLegalData_antiAddiction_payList : NSObject
@property (nonatomic, assign) NSInteger ageFrom;
@property (nonatomic, assign) NSInteger ageTo;
@property (nonatomic, assign) NSInteger singleRechargeLimit;
@property (nonatomic, assign) NSInteger monthRechargeLimit;
@end

@interface RXLegalData_antiAddiction_pay : NSObject
@property (nonatomic, assign) NSInteger allowMinAge;
