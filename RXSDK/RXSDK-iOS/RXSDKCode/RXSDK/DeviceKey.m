...
@implementation DeviceKey

+ (NSString *)getDeviceIDInKeychain
{
    NSString *getUDIDInKeychain = (NSString *)[DeviceKey load:KEY_UDID_INSTEAD];
...
//        NSLog(@"重新存储%@",result);
        [DeviceKey save:KEY_UDID_INSTEAD data:result];
        getUDIDInKeychain = (NSString *)[DeviceKey load:KEY_UDID_INSTEAD];
    }
