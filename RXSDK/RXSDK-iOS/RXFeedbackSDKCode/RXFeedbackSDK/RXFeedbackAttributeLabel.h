...
@protocol RXFeedbackAttributeLabelDelegate <NSObject>

- (void)rxAttributeClick:(NSString *)text;

@end

@interface RXFeedbackAttributeLabel : UIView
...
@property (nonatomic, weak) id <RXFeedbackAttributeLabelDelegate> delegate;
