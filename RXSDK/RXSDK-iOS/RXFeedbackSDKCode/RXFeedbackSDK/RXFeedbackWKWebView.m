...
@interface RXFeedbackWKWebView () <WKNavigationDelegate, WKUIDelegate>
...
@implementation RXFeedbackWKWebView
                    ...
                    content:(NSString *)content
{
    ...
    if (self) {
        ...
        self.orientation = [RXFeedbackTool getInterfaceOrientation];
...
- (void)webView:(WKWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler{
    ...
    if (navigationAction.navigationType == WKNavigationTypeLinkActivated) {
        // 通过浏览器访问
        RXFeedbackWKWebView *webView = [[RXFeedbackWKWebView alloc] initWithUrl:scheme title:self.title content:nil];
