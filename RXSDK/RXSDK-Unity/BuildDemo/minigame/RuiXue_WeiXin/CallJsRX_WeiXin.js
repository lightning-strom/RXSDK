...
export const CallJsRX = {
  ...
  jsrx_getUserDeviceCode:function (){
    ...
    // 上报付费
    jsrx_reportPurchase:function (amount, needReportMidas = false){
        this.jsrx_log("CallJsRX.jsrx_reportPurchase", amount, needReportMidas);
        sdk.reportPurchase(amount, needReportMidas);
    },

    // 上报等级提升
    jsrx_reportUpdateLevel:function (amount, needReportMidas = false){
        this.jsrx_log("CallJsRX.jsrx_reportUpdateLevel", amount, needReportMidas);
        sdk.reportPurchase(amount, needReportMidas);
    },
    ...
    jsrx_reportViewContent:function (item){
        this.jsrx_log("CallJsRX.jsrx_reportViewContent");
