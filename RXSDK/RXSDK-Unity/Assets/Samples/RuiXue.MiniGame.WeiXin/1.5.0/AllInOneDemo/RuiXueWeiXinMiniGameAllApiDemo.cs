...
public class RuiXueWeiXinMiniGameDemo : MonoBehaviour
{
    ...
    {
        RXAd.RewardedVideoAd("adunit-fd3c39605021b6ca", false, OnResponse, OnError);
    }
    ...
    {
        RXMiniGameWeiXin.GetDynamicShareActivityId(OnResponse, OnError);
    }
    
    public void _OnShare()
    {
        Dictionary<string, object> dic = new();
        dic.Add("func", "unity_test");
