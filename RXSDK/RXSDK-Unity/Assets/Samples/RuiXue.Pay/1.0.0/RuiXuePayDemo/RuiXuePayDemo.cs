...
public class RuiXuePayDemo : MonoBehaviour
{
    ...
    private void CheckOutPay()
    {
        ...
        dic.Add("goods_tag", "ios_tag");
        dic.Add("currency", "HKD");
        dic.Add("age", 18);
        
        Dictionary<string, object> extmap = new();
        extmap.Add("country_code", "HK");
        extmap.Add("return_url", "https://www.baidu.com?d=3&d13s=3131sjkaskdjkjasdkasdjk");
        dic.Add("ext", extmap);
        
        dic.Add("openid", "rxu7yMR4b-K6ZeqwdwytZYi1oixM0QlBGPYkW1pE");
        dic.Add("h5_setting_id", 22);
        dic.Add("h5_platform_id", "1716366554976new_create");
    ...
    public void OnQueryProductDetailsAsync()
    {
        ...
        productIdList.Add("com.ruixue.sdkpublic1");
        // productIdList.Add("com.ruixue.sdkpublic1");
        // productIdList.Add("com.ruixue.sdkpublic1");
