...
namespace WeChatWASM
{
    public class WXConvertCore
    {
        ...
        private static void ConvertCode()
        {
            ...
            text = text.Replace(
                "_emscripten_set_main_loop_timing(timingMode,timingValue);Browser.mainLoop.scheduler()},updateStatus:function()",
                "_emscripten_set_main_loop_timing(timingMode,timingValue);if(typeof Browser.mainLoop.scheduler==\"function\")Browser.mainLoop.scheduler()},updateStatus:function()"
            );
