...
public class RuiXueBaseDemo : MonoBehaviour
{
    ...
    private void OnSetThirdGameInfo()
    {
        GameInfo info = new(2, "1001", "S001")
        {
            roleName = "剑圣",
            serverName = "华东1区",
            gameRoleLevel = "36",
    ...
    public void ExitApp()
    {
        ...
        // RuiXueSdk.GetTempNotice(AnnounceResponseDelegate, AnnounceErrorDelegate);
