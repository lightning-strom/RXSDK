...
public class IOSZaloBuildPostProcessor
{
	private static RuiXueSDK_ZaloXcodeSetting _setting;
	...
	public static void OnPostProcessBuild(BuildTarget target, string path)
	{
		...
		_setting =  AssetDatabase.LoadAssetAtPath<RuiXueSDK_ZaloXcodeSetting>(RuiXueSDK_ZaloXcodeSetting.AssetPath);
		if (_setting == null)
			return;
	...
	static void SettingInfoPlist(string path)
	{
		...
		queriedUrlScheme.AddString("zalosdk");
		queriedUrlScheme.AddString("zaloshareext");
		...
		urlTypeDict.SetString("CFBundleURLName", "zalo");
		var urlScheme = urlTypeDict.CreateArray("CFBundleURLSchemes");
		urlScheme.AddString(_setting.zaloAppID);
