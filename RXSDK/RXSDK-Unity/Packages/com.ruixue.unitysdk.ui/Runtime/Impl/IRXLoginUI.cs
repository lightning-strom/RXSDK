...
namespace RuiXue.LoginUI.Impl
{
    internal interface IRXLoginUI
    {
        ...
        void ShowOAuthLoginUI(LoginUIConfig config, RequestResponseDelegate responseDelegate, RequestErrorDelegate errorDelegate);
        /// <summary>
        ///     显示登录界面
        /// </summary>
        /// <param name="config"></param>
        ...
        /// <param name="config"></param>
        /// <param name="callback"></param>
        void FindPasswordUI(FindPasswordUIConfig config, RequestResponseDelegate responseDelegate, 
        ...
        /// </summary>
        /// <param name="callback"></param>
        void RealAuthUI(RequestResponseDelegate responseDelegate, RequestErrorDelegate errorDelegate);
