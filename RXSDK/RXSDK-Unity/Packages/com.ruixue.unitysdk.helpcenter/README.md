...
| 项 | 内容 |
|----|------|
| UPM 名称 | `com.ruixue.unitysdk.helpcenter` |
| 依赖 | `com.ruixue.unitysdk.base` @ `1.6.17`<br>`com.ruixue.unitysdk.ui` @ `1.6.17` |
...
```json
"com.ruixue.unitysdk.helpcenter": "x.y.z"
```
...
- **RuiXueHelpDemo**：示例工程（`Samples~/Demo`）
