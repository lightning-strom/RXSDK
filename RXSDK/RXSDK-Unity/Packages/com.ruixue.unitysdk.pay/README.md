...
| 项 | 内容 |
|----|------|
| UPM 名称 | `com.ruixue.unitysdk.pay` |
| 依赖 | `com.ruixue.unitysdk.base` @ `4.0.0` |
...
- **RuiXuePayDemo**：示例工程（`Samples~/Demo`）

星驿 App/H5 支付请同时安装 `com.ruixue.unitysdk.xingyi`，并使用
`RXXingYiPay.PayApp` / `RXXingYiPay.PayH5`。
