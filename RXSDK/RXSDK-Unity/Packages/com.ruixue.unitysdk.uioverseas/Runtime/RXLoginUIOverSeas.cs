...
using RuiXue.LoginUIOverSeas.Impl;

namespace RuiXue.LoginUIOverSeas
{
    public static class RXLoginUIOverSeas
    {
#if UNITY_ANDROID
        private static readonly IRXLoginUIOverSeas _sdk = new RXLoginUIOverSeasAndroid();
#elif UNITY_IOS
        private static IRXLoginUIOverSeas _sdk = new RXLoginUIOverSeasIOS();
#else
        private static IRXLoginUIOverSeas _sdk = new RXLoginUIOverSeasNotSupport();
#endif
        ...
        /// <param name="responseDelegate"></param>
        /// <param name="errorDelegate"></param>
        public static void RealAuthUI(bool cancelAble, RequestResponseDelegate responseDelegate, RequestErrorDelegate errorDelegate)
        {
            _sdk.RealAuthUI(cancelAble, responseDelegate, errorDelegate);
        }
        ...
        {
            _sdk.bindEmail(responseDelegate, errorDelegate);
        }
    }
}
