...
| region           | string   | 否               | 地区       |
| sex              | int   | 否                  | 性别 1 男 0 女，<span style='color:red'>无改动传-1，不传会默认修改为女性</span> |
...
1. 非微信登录领取红包场景
2. 游客绑定三方账号场景，<span style="color:#ff0000; background-color:#f8f8f8;">**iOS**: RXSDK_Pure 4.0.2 以上，RXFacebookSDK RXGoogleSDK 需要更新到 4.0.0 以上支持。 **Android**: 4.0.6 以上支持。 **Unity**：1.6.22 以上支持。</span>
:::
