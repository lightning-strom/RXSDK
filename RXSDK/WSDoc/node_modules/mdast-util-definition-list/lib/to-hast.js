...
export const mdastDefList2hast = (state, node, _parent) => {
    ...
    const result = { type: 'element', tagName: 'dl', children, properties: {} };
    state.patch(node, result);
    return result;
};
export const mdastDefListTerm2hast = (state, node, _parent) => {
    const result = {
        type: 'element',
        tagName: 'dt',
        properties: {},
...
export const mdastDefListDescription2hast = (state, node, _parent) => {
    const children = [];
    ...
    const result = { type: 'element', tagName: 'dd', properties: {}, children };
    state.patch(node, result);
    return result;
};
