package com.ruixue.view.float.core
...
import com.ruixue.view.easyfloat.WARN_ACTIVITY_NULL
import com.ruixue.view.easyfloat.anim.AnimatorManager
import com.ruixue.view.easyfloat.core.FloatingWindowManager
import com.ruixue.view.easyfloat.core.TouchUtils
import com.ruixue.view.easyfloat.data.FloatConfig
import com.ruixue.view.easyfloat.enums.ShowPattern
import com.ruixue.view.easyfloat.interfaces.OnFloatTouchListener
import com.ruixue.view.easyfloat.utils.DisplayUtils
import com.ruixue.view.easyfloat.utils.InputMethodUtils
import com.ruixue.view.easyfloat.utils.LifecycleUtils
import com.ruixue.view.easyfloat.utils.Logger
import com.ruixue.view.easyfloat.widget.ParentFrameLayout
...
internal class FloatingWindowHelper(val context: Context, var config: FloatConfig) {
    ...
    private fun setGravity(view: View?) {
        ...
        val parentRect = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
