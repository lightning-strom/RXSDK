package com.ruixue.view.easyfloat.utils
...
import com.ruixue.view.easyfloat.permission.rom.RomUtils
...
object DisplayUtils {
    ...
    fun getScreenSize(context: Context): Point {
        val bounds = getRealDisplayBounds(context)
    ...
    private fun getRealDisplayMetrics(context: Context): DisplayMetrics {
        ...
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            val windowMetrics: WindowMetrics = manager.currentWindowMetrics
    ...
    private fun getRealDisplayBounds(context: Context): android.graphics.Rect {
        val manager = context.getSystemService(Context.WINDOW_SERVICE) as WindowManager
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
    ...
    private fun isHasNavigationBar(context: Context): Boolean {
        ...
        val realDisplayMetrics = getRealDisplayMetrics(context)
