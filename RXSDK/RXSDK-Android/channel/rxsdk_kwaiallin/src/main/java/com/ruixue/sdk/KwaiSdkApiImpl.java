...
public class KwaiSdkApiImpl extends RXSdkApi {
    ...
    static class Single {
        final static KwaiSdkApiImpl INSTANCE = new KwaiSdkApiImpl();
    }

    protected KwaiSdkApiImpl() {
        billingClient = new KwaiBillingImpl();
    }

    public static KwaiSdkApiImpl getInstance() {
    ...
    public void onApplicationCreate(Application application) {
        ...
        initSdk(application, kwaiConfig);
    ...
    protected void initSdk(Application application, KwaiConfig kwaiConfig) {
    ...
    public boolean isAgreedPrivacy() {
        return KwaiSdk.isSdkPrivacyAgree() && super.isAgreedPrivacy();
    }
