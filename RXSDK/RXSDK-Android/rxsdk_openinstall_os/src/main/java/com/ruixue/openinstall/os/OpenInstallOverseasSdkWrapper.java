package com.ruixue.openinstall.os;
...
public class OpenInstallOverseasSdkWrapper {
    static class Single {
        final static OpenInstallOverseasSdkWrapper INSTANCE = new OpenInstallOverseasSdkWrapper();
    }

    private OpenInstallOverseasSdkWrapper() {

    }

    @NonNull
    public static OpenInstallOverseasSdkWrapper getInstance() {
        return Single.INSTANCE;
    }


    private SharedPreferences sp;
    private static final String OPEN_INSTALL_SP_NAME = "openinstall_os";
    ...
    public void initClipData(Context context) {
        ...
        RXLogger.d("initClipData os >> " + clipStr);
        String oi = getOi(clipStr);
        if (TextUtils.isEmpty(oi)) {
            return;
        }

        RXLogger.d("initClipData os oi >>" + oi);
