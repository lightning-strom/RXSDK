...
public class SplashMainActivity extends Activity {
    ...
    public static final String TAG = SplashMainActivity.class.getSimpleName();
...
/*        if (suggestedSize != null) {
        ...
        SplashEyeAdHolder.splashEyeAd.show(SplashMainActivity.this, null, new ATSplashEyeAdListener() {
            @Override
