...
import com.ruixue.demo.overseas.databinding.ActivityCheckoutBinding;
import com.ruixue.demo.overseas.viewmodel.CheckoutViewModel;
...
public class CheckoutActivity extends AppCompatActivity {
    ...
    private void setGooglePayAvailable(boolean available) {
        if (available) {
            ...
            Toast.makeText(this, "Unfortunately, Google Pay is not available on this phone", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void requestPayment(View view) {
        ...
        if (task == null) {
            ...
            Toast.makeText(this, "Google Pay 请求构建失败", Toast.LENGTH_LONG).show();
            Log.w("CheckoutActivity", "PaymentData task is null");
            return;
        }
    ...
    private void handlePaymentSuccess(@Nullable PaymentData paymentData) {
        if (paymentData == null) {
            Log.w("CheckoutActivity", "PaymentData is null");
            Toast.makeText(this, "未获取到支付数据", Toast.LENGTH_LONG).show();
            return;
        }
        ...
        try {
            ...
            Toast.makeText(
                    this,"Successfully received payment data for "+ billingName,
            ...
            Log.e("CheckoutActivity", "Failed to parse payment data", e);
            Toast.makeText(this, "支付数据解析失败", Toast.LENGTH_LONG).show();
        }
    }
