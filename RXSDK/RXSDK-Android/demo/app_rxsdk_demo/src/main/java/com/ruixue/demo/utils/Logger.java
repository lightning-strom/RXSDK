...
public class Logger extends FrameLayout implements Thread.UncaughtExceptionHandler, Application.ActivityLifecycleCallbacks {
    ...
    private static String getDebugInfo() {
        ...
        int n = 4;
        return trace[n].getFileName() + ":" + trace[n].getLineNumber() + " " + trace[n].getMethodName() + "() ";
    }
    ...
    private void print(int type, String tag, String msg) {
        ...
        while (end < msg.length()) {
            ...
            String subMsg = getDebugInfo() + msg.substring(start, end);
            start = end;
            switch (type) {
                case Log.VERBOSE:
                    Log.v(tag, subMsg);
