...
public class FlowLayout extends ViewGroup {
    ...
    public FlowLayout(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mChildSpacing = getDimensionOrInt(a, R.styleable.FlowLayout_flChildSpacing,
                    (int) dpToPx(DEFAULT_CHILD_SPACING));
            mMinChildSpacing = getDimensionOrInt(a, R.styleable.FlowLayout_flMinChildSpacing,
                    (int) dpToPx(DEFAULT_CHILD_SPACING));
            mChildSpacingForLastRow =
                    getDimensionOrInt(a, R.styleable.FlowLayout_flChildSpacingForLastRow, SPACING_UNDEFINED);
            mRowSpacing = getDimensionOrInt(a, R.styleable.FlowLayout_flRowSpacing,
                    (int) dpToPx(DEFAULT_ROW_SPACING));
     ...
     *
     * @return The spacing, either {@linkFlowLayout#SPACING_AUTO}, or a fixed size in pixels.
     */
     ...
     *
     * @param childSpacing The spacing, either {@linkFlowLayout#SPACING_AUTO}, or a fixed size in
     *                     pixels.
     */
     ...
     *
     * @return The spacing, either {@linkFlowLayout#SPACING_AUTO},
     * {@linkFlowLayout#SPACING_ALIGN}, or a fixed size in pixels
     */
     ...
     *
     * @param childSpacingForLastRow The spacing, either {@linkFlowLayout#SPACING_AUTO},
     *                               {@linkFlowLayout#SPACING_ALIGN}, or a fixed size in pixels
     */
     ...
     * in vertical.
     *
     * @param rowSpacing The spacing, either {@linkFlowLayout#SPACING_AUTO}, or a fixed size in
     *                   pixels.
     */
