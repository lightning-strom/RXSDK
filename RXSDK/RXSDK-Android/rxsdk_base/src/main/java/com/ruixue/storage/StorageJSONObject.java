...
public class StorageJSONObject extends SharedPreferencesStorage<JSONObject> {

    public StorageJSONObject(Future<SharedPreferences> loadStoredPreferences, String storageKey) {
