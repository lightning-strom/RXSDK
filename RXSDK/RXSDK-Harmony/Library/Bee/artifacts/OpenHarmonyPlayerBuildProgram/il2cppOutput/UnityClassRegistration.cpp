extern "C" void RegisterStaticallyLinkedModulesGranular()
{
	...
	void RegisterModule_AndroidAppView();
	RegisterModule_AndroidAppView();
	...
	void RegisterModule_EmbeddedLinuxApi();
	RegisterModule_EmbeddedLinuxApi();
	...
	void RegisterModule_Infinity();
	RegisterModule_Infinity();
	...
	void RegisterModule_InstantAsset();
	RegisterModule_InstantAsset();

	void RegisterModule_Localization();
	RegisterModule_Localization();

	void RegisterModule_OcclusionCulling();
	RegisterModule_OcclusionCulling();

	void RegisterModule_OpenHarmonyJS();
	RegisterModule_OpenHarmonyJS();
	...
	void RegisterModule_TextureManager();
	RegisterModule_TextureManager();
