...
namespace UnityEditor.AddressableAssets.Build.Layout
{
    class BuildLayoutPrinter
    {
        ...
        static void WriteSummary(TabWriter writer, BuildLayout layout)
        {
            ...
            {
                bool sceneBundle = BuildLayoutHelpers.EnumerateAssets(b).FirstOrDefault(x => (x.AssetPath.EndsWith(".unity", StringComparison.OrdinalIgnoreCase) || x.AssetPath.EndsWith(".scene", StringComparison.OrdinalIgnoreCase))) != null;
