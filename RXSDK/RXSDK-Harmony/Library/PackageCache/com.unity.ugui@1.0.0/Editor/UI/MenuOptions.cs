...
namespace UnityEditor.UI
{
    ...
    static internal class MenuOptions
    {
        ...
        static public GameObject CreateImage(MenuCommand menuCommand, string name)
        {
            GameObject go;
            using (new FactorySwapToEditor())
                go = DefaultControls.CreateImage(GetStandardResources());
        ...
        static public GameObject CreateUIElementRoot(MenuCommand menuCommand, string name, Vector2 size, params Type[] components)
        {
            GameObject go;
            using (new FactorySwapToEditor())
            {
                go = DefaultControls.factory.CreateGameObject(name, components);
