...
namespace InputfieldTests
{
    public class TouchInputFieldTests : BaseInputFieldTests, IPrebuildSetup
    {
        ...
        [UnityTest]
        [UnityPlatform(exclude = new[] { RuntimePlatform.IPhonePlayer, RuntimePlatform.PS4, RuntimePlatform.PS5, RuntimePlatform.VisionOS, RuntimePlatform.Switch })] // disabled on visionOS due to UUM-61018; Switch SoftwareKeyboard blocks the tests suite without user input or a command to close it
