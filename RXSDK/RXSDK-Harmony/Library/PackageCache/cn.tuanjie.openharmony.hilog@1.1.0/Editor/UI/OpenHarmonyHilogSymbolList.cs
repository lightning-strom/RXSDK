...
{
    internal class OpenHarmonyHilogSymbolList : OpenHarmonyHilogReordableList
    {
        private Action m_ResetList;
        public OpenHarmonyHilogSymbolList(List<ReordableListItem> dataSource, Action resetList) : base(dataSource)
        {
            ShowEntryGUI = false;
        ...
        protected override void OnPlusButtonClicked()
        {
            ...
            var engineDirectory = BuildPipeline.GetPlaybackEngineDirectory(BuildTarget.OpenHarmony, BuildOptions.None);
