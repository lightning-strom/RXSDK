...
<span style='color:red'>[Qoo 官方文档](https://open.qoo-app.com/website/zh-CN/docs/open_sdk_guide) </span>
...
- <span style='color:red'>非常重要：请确保 package name 尾部包含关键字.qooapp，否则可能导致用户已安装此游戏的其它商店版本，会被此版本覆盖而引起数据丢失，我们的商店审核人员亦可能会因此而拒绝发布您的游戏。</span>
...
```
    ...
    <meta-data 
        android:name="com.qooapp.ENC_VERSION" 
        android:value="2" />
```
...
[点此跳转到 支付方式](https://doc.ruixueyun.com/main/#/view?viewPath=708d6f55-e7f8-4c32-9aa7-d5beabfdcdee)
