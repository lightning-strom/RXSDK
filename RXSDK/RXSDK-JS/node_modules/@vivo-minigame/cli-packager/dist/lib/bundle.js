...
const j=_crypto.default.createHash("SHA256");j.update(h);const k=j.digest();try{// 生成sign block, 计算block总长度, 向buf中考入数据
const e=makeSignChunk(a.options,k,b,c,d);a.signchunk=saveSignChunk(e)}catch(a){throw(0,_cliSharedUtils.error)("\u8BF7\u68C0\u67E5\u4E0B\u7B7E\u540D\u6587\u4EF6\u662F\u5426\u6B63\u786E\uFF0C\u5EFA\u8BAE\u91CD\u65B0\u751F\u6210\u7B7E\u540D\u6587\u4EF6..."),a}}/**
 *
 * @param file
