...
const h=d.map(a=>({from:_path.default.join(b.context,a.module_from),to:_path.default.join(b.build,a.module_path)}));h.length&&a.plugins.push(new _copyWebpackPlugin.default(h))}catch(a){}else if(_fs.default.existsSync(paths.PROJECT_WEBPACK_CONFIG))try{require(paths.PROJECT_WEBPACK_CONFIG).postHook(a,b)}catch(a){}}