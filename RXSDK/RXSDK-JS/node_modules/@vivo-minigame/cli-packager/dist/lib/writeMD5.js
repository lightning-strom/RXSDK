 ...
 */function writeMD5(a,b){// 遍历出pluginPath目录所有文件
const c=(0,_readdir.default)(b),d={};let e=!1;c.sort(),c.forEach(a=>{const c=_path.default.extname(a);0>[".js",".json"].indexOf(c)&&(e=!0),"plugin.json"!==a&&(d[a]=(0,_md.default)(_cliSharedUtils.fs.readFileSync(_path.default.resolve(b,a))))}),e&&(0,_cliSharedUtils.info)("\u63D2\u4EF6\u5305\u76EE\u524D\u652F\u6301js\u6587\u4EF6\uFF0C\u6682\u65F6\u4E0D\u652F\u6301\u653E\u7F6E\u5176\u4ED6\u7C7B\u578B\u6587\u4EF6\uFF0C\u5EFA\u8BAE\u4F18\u5316\u4E0B\u91CD\u65B0\u6253\u5305");const f=(0,_entries.default)(d);let g="";f.forEach(a=>{g+=a[0],g+=a[1]});// warn('插件包文件列表以及MD5值')
// warn(md5Arr)
// warn('插件包文件列表以及MD5值相加字符串')
// warn(md5Str)
// 读取manifest配置
const h=(0,_manifest.get)();h.plugins[a].provider=(0,_md.default)(g),_cliSharedUtils.fs.writeFileSync(paths.MANIFEST,(0,_stringify.default)(h,null,2))}