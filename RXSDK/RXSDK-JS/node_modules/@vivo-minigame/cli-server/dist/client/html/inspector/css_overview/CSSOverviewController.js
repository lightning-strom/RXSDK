import*as Common from'../common/common.js';import*as SDK from'../sdk/sdk.js';export class OverviewController extends Common.ObjectWrapper.ObjectWrapper{constructor(){super();this.currentUrl=self.SDK.targetManager.inspectedURL();self.SDK.targetManager.addEventListener(SDK.SDKModel.Events.InspectedURLChanged,this._checkUrlAndResetIfChanged,this);}
