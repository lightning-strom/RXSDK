import*as Diff from'../diff/diff.js';import*as TextEditor from'../text_editor/text_editor.js';export class SourceCodeDiff{constructor(textEditor){this._textEditor=textEditor;this._animatedLines=[];this._animationTimeout=null;}
...
export const EditType={Insert:Symbol('Insert'),Delete:Symbol('Delete'),Modify:Symbol('Modify'),};