import*as SDK from'../sdk/sdk.js';export class InputModel extends SDK.SDKModel.SDKModel{constructor(target){super(target);this._inputAgent=target.inputAgent();this._eventDispatchTimer=null;this._dispatchEventDataList=[];this._finishCallback=null;this._reset();}
...
InputModel.MouseEventTypes=new Map([['mousedown','mousePressed'],['mouseup','mouseReleased'],['mousemove','mouseMoved'],['wheel','mouseWheel']]);InputModel.KeyboardEventTypes=new Map([['keydown','keyDown'],['keyup','keyUp'],['keypress','char']]);SDK.SDKModel.SDKModel.register(InputModel,SDK.SDKModel.Capability.Input,false);export let EventData;export let MouseEventData;export let KeyboardEventData;