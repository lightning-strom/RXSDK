...
return num;};Number.gcd=function(a,b){if(b===0){return a;}
return Number.gcd(b,a%b);};Number.toFixedIfFloating=function(value){if(!value||isNaN(value)){return value;}
