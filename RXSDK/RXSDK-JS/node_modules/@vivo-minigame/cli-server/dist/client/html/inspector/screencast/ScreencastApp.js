import*as Common from'../common/common.js';import*as SDK from'../sdk/sdk.js';import*as UI from'../ui/ui.js';import{ScreencastView}from'./ScreencastView.js';let _appInstance;export class ScreencastApp{constructor(){this._enabledSetting=self.Common.settings.createSetting('screencastEnabled',true);this._toggleButton=new UI.Toolbar.ToolbarToggle(Common.UIString.UIString('Toggle screencast'),'largeicon-phone');this._toggleButton.setToggled(this._enabledSetting.get());this._toggleButton.setEnabled(false);this._toggleButton.addEventListener(UI.Toolbar.ToolbarButton.Events.Click,this._toggleButtonClicked,this);self.SDK.targetManager.observeModels(SDK.ScreenCaptureModel.ScreenCaptureModel,this);}
