import*as TextUtils from'../text_utils/text_utils.js';export function toPos(range){return{start:new CodeMirror.Pos(range.startLine,range.startColumn),end:new CodeMirror.Pos(range.endLine,range.endColumn)};}
export function toRange(start,end){return new TextUtils.TextRange.TextRange(start.line,start.ch,end.line,end.ch);}
