...
//发送验证码
export const sendCaptchaWithCode = (data: any): Promise<any> =>
  request({
...
export const uploadGameInteractionInfoApi = (data: any): Promise<any> =>
  request({
...
export function validateUnbindCodeApi(data: any) {
  return request({
...
export const trackCompressedApi = (data: any) =>
request({
  method: 'POST',
  url: '/v1/data/api/track',
  data,
...
// 获取公共属性
export const getInitConf = (data: any): Promise<IResponseSdkInitConfig> =>
  request({
    url: '/v1/sdkconfig/init',
    method: 'POST',
    data
  }) as Promise<IResponseSdkInitConfig>
...
export const getPhoneNumberApi = (code: any): Promise<any> =>
  request({
...
export const changePhoneNumberApi = (code: any): Promise<any> =>
  request({
...
export const getAdSourceApi = (): Promise<any> =>
  request({
...
export const getThirdToken = (data: any): Promise<any> =>
  request({
...
// 动态消息-创建被分享动态消息的
export function createActivityIdApi(data: any): Promise<any> {
  return request({
...
// 动态消息-创建被分享动态消息的
export function setDynamicMsgApi(data: any): Promise<any> {
  return request({
...
// 获取文本短链
export function getShortTextApi(short_name: any): Promise<any> {
  return request({
    url: '/v1/text/short',
    method: 'GET',
    params: {
...
// 获取文本短链
export function getUrlParseApi(params: any): Promise<any> {
  return request({
...
// 设置文本短链
export function setShortTextApi(text: any): Promise<any> {
  return request({
    url: '/v1/text/short',
    method: 'POST',
    data: {
...
// 动态消息-chatTool
export function setChatToolMsgApi(data: any): Promise<any> {
  return request({
...
export const getOrderStatusApi = (order_no: string): Promise<any> =>
  request({
