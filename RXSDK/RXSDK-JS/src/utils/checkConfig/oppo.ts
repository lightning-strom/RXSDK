...
export const oppoLoginParamsCheck: Rules = {
  method: {
    type: 'enum',
    enum: ['minigame_oppo']
  },
...
export const oppoShareScheduleInitParams: Rules = {
  funcs: {
    type: 'array'
  }
}

export const oppoShareScheduleReportParams: Rules = {
  func: {
    type: 'string',
    required: true
  },
...
export const oppoPayCheckParams: Rules = {
  pay_type: {
    type: 'enum',
    required: true,
    enum: ['minigame_oppo']
