...
export const xiaomiPayCheckParams: Rules = {
  pay_type: {
    type: 'enum',
    required: true,
...
export const xiaomiLoginParamsCheck: Rules = {
  method: {
    type: 'enum',
    enum: ['minigame_xiaomi'],
  },
...
export const xiaomiShareScheduleInitParams: Rules = {
  funcs: {
    type: 'array'
  }
}

export const xiaomiShareScheduleReportParams: Rules = {
  func: {
    type: 'string',
    required: true
  },
