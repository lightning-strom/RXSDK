...
export const ucPayCheckParams: Rules = {
  pay_type: {
    type: 'enum',
    required: true,
    enum: ['minigame_uc']
...
export const ucLoginParamsCheck: Rules = {
  method: {
    type: 'enum',
    enum: ['minigame_uc'],
  },
...
export const ucShareScheduleInitParams: Rules = {
  funcs: {
    type: 'array'
  }
}

export const ucShareScheduleReportParams: Rules = {
  func: {
    type: 'string',
    required: true
  },
