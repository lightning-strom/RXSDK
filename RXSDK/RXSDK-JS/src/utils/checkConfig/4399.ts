...
export const m4399PayCheckParams: Rules = {
  pay_type: {
    type: 'enum',
    required: true,
    enum: ['minigame_4399']
...
export const m4399LoginParamsCheck: Rules = {
  method: {
    type: 'enum',
    enum: ['minigame_4399'],
  },
...
export const m4399ShareScheduleInitParams: Rules = {
  funcs: {
    type: 'array'
  }
}

export const m4399ShareScheduleReportParams: Rules = {
  func: {
    type: 'string',
    required: true
  },
