...
export const vivoPayCheckParams: Rules = {
  pay_type: {
    type: 'enum',
    required: true,
    enum: ['minigame_vivo']
...
export const vivoLoginParamsCheck: Rules = {
  method: {
    type: 'enum',
    enum: ['minigame_vivo'],
  },
...
export const vivoShareScheduleInitParams: Rules = {
  funcs: {
    type: 'array'
  }
}

export const vivoShareScheduleReportParams: Rules = {
  func: {
    type: 'string',
    required: true
  },
