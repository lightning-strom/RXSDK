...
//   pay_type:'minigame' | 'minigame_friend' | 'wxpub' | 'minigame_v2' | 'aums' | 'minigame_vivo' | 'minigame_taobao',
...
type IpayForTaobao = Omit<IpayParmas, 'openid'>

interface taobaoTrackForReq {
