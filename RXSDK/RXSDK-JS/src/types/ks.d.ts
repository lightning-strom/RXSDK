...
//   pay_type:'minigame' | 'minigame_friend' | 'wxpub' | 'minigame_v2' | 'aums' | 'minigame_kuaishou' | 'minigame_oppo',
...
type IpayForKs = Omit<IpayParmas, 'openid'>

interface ksTrackForReq {
