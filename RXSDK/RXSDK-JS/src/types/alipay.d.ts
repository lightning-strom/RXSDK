...
//   pay_type:'minigame' | 'minigame_friend' | 'wxpub' | 'minigame_v2' | 'aums' | 'minigame_vivo' | 'minigame_alipay',
...
type IpayForAlipay = Omit<IpayParmas, 'openid'>

interface alipayTrackForReq {
