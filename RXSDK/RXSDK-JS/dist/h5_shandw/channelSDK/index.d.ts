...
declare class SdkH5Shandw extends SdkCommon {
    ...
    private payMandatory;
    private payOptional;
    private payUrlParams;
    private initUrlParams;
    constructor(initParams: InitH5Params);
    private openId;
    private login;
    pay(params: H5ShandwPayParam, callback: H5MethodParams): Promise<void>;
    closePay(): Promise<void>;
    share(params: any, callback: IMethodParams): Promise<void>;
    chooseSDWIdentify(params: any, callback: IMethodParams): Promise<void>;
    roleReport(params: any, callback: IMethodParams): Promise<void>;
