...
declare class SdkH5Awy extends SdkCommon {
    ...
    private handleSdkPayCallback;
    private handleSdkShareCallback;
    private initAwySdk;
    private login;
    pay(params: H5AwyPayParam, callback: H5MethodParams): Promise<void>;
    private share;
