...
declare class SdkBaidu extends SdkCommon {
    ...
    private swanLogin;
    private getUserInfo;
    infoSync({ headimgurl, nickname, sex }: {
        headimgurl: string;
        nickname: string;
        sex: number;
    }, callback: RpkMethodParams): Promise<void>;
    login(params: RpkBaiduLoginParam, callback: RpkMethodParams): Promise<void>;
    pay(params: RpkBaiduPayParam, callback: RpkMethodParams): Promise<void>;
    ...
    rewardedVideoAd(data: any, { complete }: IMethodParams): Promise<void>;
