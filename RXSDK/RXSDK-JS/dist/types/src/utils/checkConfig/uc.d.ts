...
export declare const ucPayCheckParams: Rules;
export declare const initParamsCheck: Rules;
export declare const ucLoginParamsCheck: Rules;
...
export declare const ucShareScheduleInitParams: Rules;
export declare const ucShareScheduleReportParams: Rules;
