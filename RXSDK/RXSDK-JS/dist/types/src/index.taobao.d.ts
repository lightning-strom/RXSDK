...
declare class SdkTaobao extends SdkCommon {
    private shareFlag;
    private funcs;
    private isPromoter;
    ...
    login(params: RpkTaobaoLogin, callback: RpkMethodParams): Promise<void>;
    pay(params: RpkTaobaoPayParam, callback: RpkMethodParams): Promise<void>;
    share(callback: RpkMethodParams, params?: RpkTaobaoShareParams): Promise<void>;
