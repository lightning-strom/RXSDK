...
export declare const postAlipayPayData: (_url: string, data: any) => any;
...
export declare function bindGroupApi(data: any): Promise<any>;
export declare function unBindGroupApi(data: any): Promise<any>;
export declare function getShortUrlApi(data: any): Promise<any>;
export declare function getThirdGoodsTagApi(params: any): Promise<any>;
export declare const postDouyinPayData: (url: string, data: any) => any;
export declare function _getInfoApi(): any;
...
export declare const getGiftReceiveRewardApi: (data: any) => Promise<any>;
...
export declare const mtReport: (data: any) => Promise<any>;
