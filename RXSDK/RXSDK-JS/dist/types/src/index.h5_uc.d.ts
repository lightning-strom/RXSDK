...
declare class SdkH5UC extends SdkCommon {
    ...
    private reward_ad_timer;
    constructor(initParams: InitH5Params);
    private checkLogin;
    private checkSession;
    private checkSessionAvailable;
    private getSetting;
    private authorize;
    ...
    private login;
    pay(params: H5UCPayParam, callback: H5MethodParams): Promise<void>;
    private share;
