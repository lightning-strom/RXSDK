...
declare class SdkMeiTuan extends SdkCommon {
    private funcs;
    private isPromoter;
    ...
    login(params: any, callback: RpkMethodParams): Promise<void>;
    ...
    gameActionReport(params: any, callback: RpkMethodParams): Promise<void>;
}

export { SdkMeiTuan as default };
