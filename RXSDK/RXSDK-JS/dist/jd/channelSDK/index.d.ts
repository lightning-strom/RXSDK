...
declare class SdkJd extends SdkCommon {
    ...
    infoSync({ nickname, avatar, gender }: {
        nickname: string;
        avatar: string;
        gender: number;
    }, callback: RpkMethodParams): Promise<void>;
    login(params: RpkJdLoginParam, callback: RpkMethodParams): Promise<void>;
    pay(params: RpkJdPayParam, callback: RpkMethodParams): Promise<void>;
    ...
    rewardedVideoAd(data: any, { complete, fail }: RpkMethodParams): Promise<void>;
