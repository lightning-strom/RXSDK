...
declare class SdkH5Haluo extends SdkCommon {
    ...
    private openId;
    private login;
    pay(params: H5HaluoPayParam, callback: H5MethodParams): Promise<void>;
    share(params: any, callback: IMethodParams): Promise<void>;
    startRewardVideo(callback: IMethodParams): Promise<void>;
    eventReport(params: any, callback: IMethodParams): Promise<void>;
    getchannelInfo(callback: IMethodParams): Promise<void>;
    getEnv(callback: IMethodParams): Promise<void>;
