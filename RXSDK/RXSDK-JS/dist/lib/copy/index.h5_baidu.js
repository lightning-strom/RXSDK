...
var config_2 = require("../src/h5/config");
var const_1 = require("../src/config/const");
var utils_1 = require("../src/utils/utils");
var day_1 = require("../src/utils/day");
var is_1 = require("../src/utils/is");
var paramsValid_1 = require("../src/utils/paramsValid");
var utils_2 = require("../src/h5/utils");
var checkConfig_1 = require("../src/h5/checkConfig");
var apis_1 = require("../src/h5/apis");
var SdkCommon_1 = require("../src/h5/SdkCommon");
var PLATFORM = 'minigame_baiduh5';
var SdkH5Baidu = /** @class */ (function (_super) {
    ...
    function SdkH5Baidu(initParams) {
        ...
        if (window.QQSY_SDK) {
            ...
            _this.loadScript("https://h5sdk.cdqcwl.com/static/sdk/channel_js_sdk/baidu.js")
                .then(function () {
                _this.getInitConfig({ complete: initParams.complete });
            })
                .catch(function (err) {
    ...
    SdkH5Baidu.prototype.login = function (params, callback) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user_source, now, distinct_idLocal, distinct_id, requestParams, queryJson, user_info, reflowEnabled, source_ad, reqLogin, login_info, err_1;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        requestParams = __assign({ ts: now, method: params.method || 'minigame_baiduh5', distinct_id: distinct_id, ext: params.ext }, user_source);
                        try {
                    ...
                    case 2:
                        ...
                        reqLogin.ext = __assign(__assign({}, reqLogin.ext), { user_id: login_info.user_id });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.H5XunleiPayCheckParams, callback, params)];
                    case 1:
                        _a.sent();
    ...
    SdkH5Baidu.prototype.getInitConfig = function (callback) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var initParams, res, config, version, _i, _d, key, prop_version, err_4, error;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        config = res.data || {};
                        version = {};
                        for (_i = 0, _d = Object.keys(config); _i < _d.length; _i++) {
                            key = _d[_i];
    ...
    SdkH5Baidu.prototype.track = function (params, callback) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var getDevicecode, devicecode, type, time, uuids, platform_id, copyCpid, product_id, cpid, publicPropskey, publicPropsByCache, publicProps, reqarr, result, err_7;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _d.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        reqarr = [
                            __assign({ type: type, time: time, uuid: uuids, sub_channel_id: config_1.USER_INFO.subchannelid, distinct_id: config_1.USER_INFO.openid, platform_id: platform_id, product_id: product_id, cpid: cpid, channel_id: config_1.SYSTEM_INFO.channelId, devicecode: devicecode }, __assign(__assign({}, params), { properties: __assign(__assign({}, publicProps), params.properties) }))
                        ];
                    ...
                    case 3:
                        err_7 = _d.sent();
                        callback.complete((0, utils_1.handleError)(err_7));
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
                }
            });
...
//# sourceMappingURL=index.h5_baidu.js.map