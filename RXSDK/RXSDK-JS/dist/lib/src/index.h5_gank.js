...
function findChannelData(params, optional) {
    ...
    // 先检查当前窗口的URL
    channelData = getChannelDataFromUrl(window.location.href, channelMandatory, optional);
    ...
    channelData = getChannelDataFromUrl(window.top.location.href, channelMandatory, optional);
...
var SdkH5Gank = /** @class */ (function (_super) {
    ...
    function SdkH5Gank(initParams) {
        ...
        // 获取三方渠道数据
        config_1.SYSTEM_INFO.third_channel_Data = findChannelData(_this.loginMandatory);
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        parasmData = {
                            ...
                            data: __assign(__assign({}, (params === null || params === void 0 ? void 0 : params.data) || {}), { deviceid: ((_a = config_1.SYSTEM_INFO === null || config_1.SYSTEM_INFO === void 0 ? void 0 : config_1.SYSTEM_INFO.third_channel_Data) === null || _a === void 0 ? void 0 : _a.uid) || '', channelid: ((_b = config_1.SYSTEM_INFO === null || config_1.SYSTEM_INFO === void 0 ? void 0 : config_1.SYSTEM_INFO.third_channel_Data) === null || _b === void 0 ? void 0 : _b.channel) || '', subchid: ((_c = config_1.SYSTEM_INFO === null || config_1.SYSTEM_INFO === void 0 ? void 0 : config_1.SYSTEM_INFO.third_channel_Data) === null || _c === void 0 ? void 0 : _c.subchid) || '', extInfo: JSON.stringify(config_1.SYSTEM_INFO === null || config_1.SYSTEM_INFO === void 0 ? void 0 : config_1.SYSTEM_INFO.third_channel_Data) || '' })
                        };
                        return [4 /*yield*/, (0, apis_1.unicornRegisterReportApi)(parasmData)
    ...
    SdkH5Gank.prototype.getThirdChannelData = function (callback) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                    callback.complete({ code: 0, msg: '获取三方渠道数据成功', data: (config_1.SYSTEM_INFO === null || config_1.SYSTEM_INFO === void 0 ? void 0 : config_1.SYSTEM_INFO.third_channel_Data) || {} });
                }
                catch (error) {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        requestParams = __assign({ ts: now, method: params.method || 'unicornh5', distinct_id: distinct_id, ext: config_1.SYSTEM_INFO.third_channel_Data }, user_source);
                        try {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        _j.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.H5GankPayCheckParams, callback, params)];
                    case 1:
                        _j.sent();
                        if (params.indulge_auth == 1 && !params.age) {
                            throw Error('when indulge_auth equal 1,the age must be required');
                        }
                        reqOrder = __assign(__assign({}, params), { currency: params.currency || 'CNY', openid: config_1.USER_INFO.openid, sub_channel_id: config_1.USER_INFO === null || config_1.USER_INFO === void 0 ? void 0 : config_1.USER_INFO.subchannelid, is_debug: params.is_debug || 0, env: params.env || 0, userData: __assign(__assign({}, config_1.SYSTEM_INFO === null || config_1.SYSTEM_INFO === void 0 ? void 0 : config_1.SYSTEM_INFO.third_channel_Data), { openid: config_1.USER_INFO.openid }) });
    ...
    SdkH5Gank.prototype.roleReport = function (params, callback) {
        var _a, _b;
        try {
            getGankSDK().report(__assign(__assign({}, params || {}), { type: params.type || '', who: params.userRoleId || '', serverid: params.serverId || '', level: params.userRoleLevel || '', power: params.gameRolePower || '', rolename: params.userRoleName || '', role_vip: params.vipLevel || 1, servername: params.serverName || '', appid: this.channelGameId || '', deviceid: ((_a = config_1.SYSTEM_INFO === null || config_1.SYSTEM_INFO === void 0 ? void 0 : config_1.SYSTEM_INFO.third_channel_Data) === null || _a === void 0 ? void 0 : _a.uid) || '', channelid: ((_b = config_1.SYSTEM_INFO === null || config_1.SYSTEM_INFO === void 0 ? void 0 : config_1.SYSTEM_INFO.third_channel_Data) === null || _b === void 0 ? void 0 : _b.channel) || '' }));
...
exports.default = SdkH5Gank;
//# sourceMappingURL=index.h5_gank.js.map