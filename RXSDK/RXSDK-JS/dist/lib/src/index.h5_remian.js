        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_5) {
                switch (_5.label) {
                    case 0:
                        _5.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.H5RemianPayCheckParams, callback, params)];
                    case 1:
                        _5.sent();
                        if (params.indulge_auth == 1 && !params.age) {
                            throw Error('when indulge_auth equal 1,the age must be required');
                        }
                        reqOrder = __assign(__assign({}, params), { currency: params.currency || 'CNY', sub_channel_id: config_1.USER_INFO === null || config_1.USER_INFO === void 0 ? void 0 : config_1.USER_INFO.subchannelid, is_debug: params.is_debug || 0, env: params.env || 0, openid: config_1.USER_INFO.openid, ext: {
...
exports.default = SdkH5Remian;
//# sourceMappingURL=index.h5_remian.js.map