...
var PLATFORM = 'gametokh5';
function findSDK(maxDepth) {
    if (maxDepth === void 0) { maxDepth = 5; }
    var currentWindow = window;
    var depth = 0;
    while (currentWindow && depth < maxDepth) {
        // 检查当前窗口是否存在 GameTokSDK 对象
        if (currentWindow.GameTokSDK) {
            return currentWindow.GameTokSDK;
        }
    ...
    // 如果没有找到 GameTokSDK 对象
    return null;
}
// 使用示例
var GameTokSDK = findSDK();
if (GameTokSDK) {
    console.info('找到 GameTokSDK 对象:', GameTokSDK);
}
else {
    console.info('未找到 GameTokSDK 对象');
}
// 获取url参数
...
var SdkH5Gametok = /** @class */ (function (_super) {
    __extends(SdkH5Gametok, _super);
    function SdkH5Gametok(initParams) {
        ...
        _this.secretData = {};
        // 登录必要参数
        _this.loginMandatory = ['gameId', 'token'];
        // 初始化url参数
        _this.initUrlParams = {};
        // 百度页游嵌入式充值相关
    ...
    SdkH5Gametok.prototype.login = function (params, callback) {
        var _a, _b, _c, _d;
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        requestParams = __assign({ ts: now, method: params.method || 'gametokh5', distinct_id: distinct_id, ext: params.ext }, user_source);
                        try {
    ...
    // 支付
    SdkH5Gametok.prototype.pay = function (params, callback) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.H5GametokPayCheckParams, callback, params)];
                    case 1:
                        _c.sent();
                        if (params.indulge_auth == 1 && !params.age) {
                            throw Error('when indulge_auth equal 1,the age must be required');
                        }
                        reqOrder = __assign(__assign({}, params), { currency: params.currency || 'CNY', sub_channel_id: config_1.USER_INFO === null || config_1.USER_INFO === void 0 ? void 0 : config_1.USER_INFO.subchannelid, is_debug: params.is_debug || 0, env: params.env || 0, openid: config_1.USER_INFO.openid, ext: __assign(__assign({}, params.ext || {}), this.initUrlParams) });
                        return [4 /*yield*/, (0, apis_1.orderApi)(reqOrder)
                            // ext 中的 status 为success 则表示支付成功
                        ];
                    case 2:
                        result = _c.sent();
                        // ext 中的 status 为success 则表示支付成功
                        if (((_b = (_a = result === null || result === void 0 ? void 0 : result.data) === null || _a === void 0 ? void 0 : _a.ext) === null || _b === void 0 ? void 0 : _b.status) === 'success') {
                            callback.complete({ code: 0, data: result === null || result === void 0 ? void 0 : result.data, msg: '支付成功' });
                        }
                        else {
                            callback.complete((0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_pay', result));
                        }
                        return [3 /*break*/, 4];
                    case 3:
                        err_2 = _c.sent();
    ...
    // 上报分数
    SdkH5Gametok.prototype.roleReport = function (params, callback) {
        try {
            GameTokSDK.addScore({ score: (params === null || params === void 0 ? void 0 : params.score) || 0, scoreType: (params === null || params === void 0 ? void 0 : params.scoreType) || '', remark: (params === null || params === void 0 ? void 0 : params.remark) || '' })
                .then(function () {
                callback.complete({ code: 0, msg: '上报成功' });
            })
                .catch(function (e) {
                callback.complete((0, utils_2.handleTrackError)(PLATFORM, '', e));
            });
        }
        catch (error) {
    ...
    // 分享
    SdkH5Gametok.prototype.share = function (callback) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Gametok.prototype.schedulingAction = function (params, callback) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
    ...
    //获得分享内容
    SdkH5Gametok.prototype.getAdShareData = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Gametok.prototype.rewardedVideoAd = function (_a) {
        var complete = _a.complete;
    };
    SdkH5Gametok.prototype.setScheuleReportProps = function (data) {
    ...
    // 获得公共属性
    SdkH5Gametok.prototype.getPublicProperties = function () {
     ...
     */
    SdkH5Gametok.prototype.setPublicProperties = function (params) {
     ...
     * 修改设置的公共数据。
     */
    SdkH5Gametok.prototype.updatePublicProperties = function (params) {
        if (!(0, is_1.isObject)(params)) {
            var error = new Error('params must be object');
            error.code = const_1.COMMON_ERROR_CODE.PAY_PARAMS_ERROR;
            return (0, utils_2.handleTrackError)(PLATFORM, '', error);
     ...
     * 删除公共属性
     */
    SdkH5Gametok.prototype.deletePublicProperties = function (params) {
        try {
            var cache = (0, utils_2.customGetStorageSync)('rx_public_props');
            // @ts-ignore
    ...
    //获得分享内容
    SdkH5Gametok.prototype.getShareData = function (params, callback, stopCallback) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    // 获取埋点调度
    SdkH5Gametok.prototype.getShareScheduling = function (params) {
    ...
    // 分享调度初始化
    SdkH5Gametok.prototype.shareSchedulingInit = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var req, res, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    // 看广告完成上报
    SdkH5Gametok.prototype.shareSchedulingReport = function (params, callback) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Gametok.prototype.getInitConfig = function (callback) {
    ...
    SdkH5Gametok.prototype.publicSubchannelCheck = function (res) {
        var _a, _b;
        try {
    ...
    // 获取归因数据
    SdkH5Gametok.prototype.getAttributionData = function () {
    ...
    SdkH5Gametok.prototype.checkNeedActivate = function () {
        return __awaiter(this, void 0, void 0, function () {
     ...
     *
     */
    SdkH5Gametok.prototype.loopGetPublicProps = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
    ...
    //格式化queryString
    SdkH5Gametok.prototype.getLoginQsAndGenerateStruct = function () {
        var _a;
        var universal = (0, utils_2.getSearchQueries)();
        var user_source = {};
    ...
    SdkH5Gametok.prototype.ActivePrefix = function (reqParams) {
     ...
     */
    SdkH5Gametok.prototype.setSubChannelId = function (subChannelId) {
        try {
    ...
    SdkH5Gametok.prototype.loadScript = function (url) {
    ...
    //商业广告
    SdkH5Gametok.prototype.getAllBusinessData = function (callback) {
        return __awaiter(this, void 0, void 0, function () {
            var data, result;
            return __generator(this, function (_a) {
                try {
    ...
    // 条件获取商业化窗口数据
    SdkH5Gametok.prototype.getBusinessData = function (params, callback) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
    ...
    // 更新商业化窗口数据
    SdkH5Gametok.prototype.refreshBusinessData = function (callback, isRecord) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Gametok.prototype.dispatchBusinessWindowsQueue = function () {
        return __awaiter(this, void 0, void 0, function () {
            var execute;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    // 商业化下单
    SdkH5Gametok.prototype.requestBusinessOrder = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var result, err_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SdkH5Gametok.prototype.clearPromoterTimer = function () {
    ...
    // 启动定时器
    SdkH5Gametok.prototype.startPromoterTimer = function (callback, autoRefresh) {
        var _this = this;
    ...
    // 获取福利码
    SdkH5Gametok.prototype.getPromoDisplayKEY = function (callback, autoRefresh, immediately) {
        var _this = this;
    ...
    // 兑换福利码
    SdkH5Gametok.prototype.exchangePromoCDKEY = function (cdkey, callback) {
    ...
    SdkH5Gametok.prototype.checkIsPromoter = function () {
        return this.is_promoter;
    };
    return SdkH5Gametok;
}(SdkCommon_1.default));
exports.default = SdkH5Gametok;
//# sourceMappingURL=index.h5_gametok.js.map