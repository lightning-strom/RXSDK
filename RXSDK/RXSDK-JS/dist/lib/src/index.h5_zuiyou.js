...
var PLATFORM = 'minigame_zuiyou';
var SdkH5Zuiyou = /** @class */ (function (_super) {
    __extends(SdkH5Zuiyou, _super);
    function SdkH5Zuiyou(initParams) {
        ...
        if (window.__XCgs) {
            ...
            _this.loadScript('https://static.ixiaochuan.cn/game-sdk/sdk.1.1.0.js')
                .then(function () {
                _this.getInitConfig({ complete: initParams.complete });
            })
                .catch(function (err) {
    ...
    SdkH5Zuiyou.prototype.login = function (params, callback) {
        var _a, _b, _c, _d;
        return __awaiter(this, void 0, void 0, function () {
            var user_source, now, distinct_idLocal, distinct_id, requestParams, queryJson, user_info, reflowEnabled, source_ad, reqLogin, login_info, nickname, avatar, extra_param, _e, custom_ext, rest_ext, err_1;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        requestParams = __assign({ ts: now, method: params.method || 'minigame_zuiyou', distinct_id: distinct_id, ext: params.ext }, user_source);
                        try {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.zuiyouInit(config_1.SYSTEM_INFO.appkey)];
                    case 3:
                        login_info = _f.sent();
                        nickname = '';
                        avatar = '';
                        try {
                            extra_param = JSON.parse(login_info.extra_param);
                        ...
                        reqLogin.ext = __assign(__assign({}, (rest_ext || {})), { uid: login_info.uid, ts: "".concat(login_info.ts), sign: login_info.sign, nickname: nickname, avatar: avatar });
    ...
    SdkH5Zuiyou.prototype.zuiyouInit = function (appkey) {
        return new Promise(function (resolve, reject) {
            __XCgs.call('init')(appkey, function (err, res) {
                if (err) {
                    reject(err);
                    return;
                }
    ...
    // 支付
    SdkH5Zuiyou.prototype.pay = function (params, callback) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.H5ZuiyouPayCheckParams, callback, params)];
                    case 2:
                        _b.sent();
                    ...
                    case 3:
                        result = _b.sent();
                        __XCgs.call('pay')((_a = result === null || result === void 0 ? void 0 : result.data) === null || _a === void 0 ? void 0 : _a.ext, function (err, res) {
                            if (err) {
                                if (err.code == 100000) {
                            ...
                            if (res && res.status == 1) {
                                ...
                                console.log(res);
                                callback.complete((0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_pay', __assign({ code: const_1.COMMON_ERROR_CODE.PAY_ERROR, msg: '支付错误' }, res)));
                            }
                        });
                        return [3 /*break*/, 5];
                    case 4:
    ...
    SdkH5Zuiyou.prototype.schedulingAction = function (params, callback) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
    ...
    //获得分享内容
    SdkH5Zuiyou.prototype.getAdShareData = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Zuiyou.prototype.rewardedVideoAd = function (_a) {
        ...
        __XCgs.call('playRewardAd')(function (err, res) {
            ...
            if (err) {
                complete((0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_ad', __assign(__assign({}, err), { msg: '获取广告结果异常' })));
                return;
            }
            if (res && res.status == 1) {
                complete({
    ...
    SdkH5Zuiyou.prototype.setScheuleReportProps = function (data) {
    ...
    // 获得公共属性
    SdkH5Zuiyou.prototype.getPublicProperties = function () {
     ...
     */
    SdkH5Zuiyou.prototype.setPublicProperties = function (params) {
     ...
     * 修改设置的公共数据。
     */
    SdkH5Zuiyou.prototype.updatePublicProperties = function (params) {
        if (!(0, is_1.isObject)(params)) {
            var error = new Error('params must be object');
            error.code = const_1.COMMON_ERROR_CODE.PAY_PARAMS_ERROR;
            return (0, utils_2.handleTrackError)(PLATFORM, '', error);
     ...
     * 删除公共属性
     */
    SdkH5Zuiyou.prototype.deletePublicProperties = function (params) {
        try {
            var cache = (0, utils_2.customGetStorageSync)('rx_public_props');
            // @ts-ignore
    ...
    //获得分享内容
    SdkH5Zuiyou.prototype.getShareData = function (params, callback, stopCallback) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    // 获取埋点调度
    SdkH5Zuiyou.prototype.getShareScheduling = function (params) {
    ...
    // 分享调度初始化
    SdkH5Zuiyou.prototype.shareSchedulingInit = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var req, res, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    // 看广告完成上报
    SdkH5Zuiyou.prototype.shareSchedulingReport = function (params, callback) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Zuiyou.prototype.getInitConfig = function (callback) {
    ...
    SdkH5Zuiyou.prototype.publicSubchannelCheck = function (res) {
        var _a, _b;
        try {
    ...
    // 获取归因数据
    SdkH5Zuiyou.prototype.getAttributionData = function () {
    ...
    SdkH5Zuiyou.prototype.checkNeedActivate = function () {
        return __awaiter(this, void 0, void 0, function () {
     ...
     *
     */
    SdkH5Zuiyou.prototype.loopGetPublicProps = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
    ...
    //格式化queryString
    SdkH5Zuiyou.prototype.getLoginQsAndGenerateStruct = function () {
        var _a;
        var universal = (0, utils_2.getSearchQueries)();
        var user_source = {};
    ...
    SdkH5Zuiyou.prototype.ActivePrefix = function (reqParams) {
     ...
     */
    SdkH5Zuiyou.prototype.setSubChannelId = function (subChannelId) {
        try {
    ...
    SdkH5Zuiyou.prototype.loadScript = function (url) {
        return new Promise(function (resolve, reject) {
    ...
    //商业广告
    SdkH5Zuiyou.prototype.getAllBusinessData = function (callback) {
        return __awaiter(this, void 0, void 0, function () {
            var data, result;
            return __generator(this, function (_a) {
                try {
    ...
    // 条件获取商业化窗口数据
    SdkH5Zuiyou.prototype.getBusinessData = function (params, callback) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
    ...
    // 更新商业化窗口数据
    SdkH5Zuiyou.prototype.refreshBusinessData = function (callback, isRecord) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Zuiyou.prototype.dispatchBusinessWindowsQueue = function () {
        return __awaiter(this, void 0, void 0, function () {
            var execute;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    // 商业化下单
    SdkH5Zuiyou.prototype.requestBusinessOrder = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var result, err_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SdkH5Zuiyou.prototype.clearPromoterTimer = function () {
    ...
    // 启动定时器
    SdkH5Zuiyou.prototype.startPromoterTimer = function (callback, autoRefresh) {
        var _this = this;
    ...
    // 获取福利码
    SdkH5Zuiyou.prototype.getPromoDisplayKEY = function (callback, autoRefresh, immediately) {
        var _this = this;
    ...
    // 兑换福利码
    SdkH5Zuiyou.prototype.exchangePromoCDKEY = function (cdkey, callback) {
    ...
    SdkH5Zuiyou.prototype.checkIsPromoter = function () {
        return this.is_promoter;
    };
    return SdkH5Zuiyou;
}(SdkCommon_1.default));
exports.default = SdkH5Zuiyou;
//# sourceMappingURL=index.h5_zuiyou.js.map