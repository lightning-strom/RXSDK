...
var SdkMgtv = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        _e.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(mgtv.getUserProfile, {})];
                    case 1:
    ...
    SdkMgtv.prototype.login = function (params, callback) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user_source, source_ad, distinct_idLocal, distinct_id, now, reqLogin, queryJson, userInfoResult, e_1, _l, custom_ext, rest_ext, loginTokenRx, reflowEnabled, loginRx, err_1;
            return __generator(this, function (_m) {
                switch (_m.label) {
                    case 0:
                        _m.trys.push([0, 11, , 12]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.mgtvLoginParamsCheck, callback, params)];
                    case 1:
                        _m.sent();
                        ...
                        userInfoResult = {};
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(mgtv.login, {})];
                    case 2:
                        _m.sent();
                        _m.label = 3;
                    case 3:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_o) {
                switch (_o.label) {
                    case 0:
                        _o.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.mgtvPayCheckParams, callback, params)];
                    case 1:
                        _o.sent();
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(mgtv.requestPaymentGameItem, {
                    ...
                    case 4:
                        ...
                        if (err_2.errMsg.includes('取消')) {
                            callback.complete((0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_pay', err_2, const_1.COMMON_ERROR_CODE.CANCEL_PAY));
                            return [2 /*return*/];
                        }
            ...
            return __generator(this, function (_11) {
                switch (_11.label) {
                    ...
                    case 1:
                        ...
                        compare = (0, is_1.compareVersions)(deviceInfo.SDKVersion, '1.2.9');
                        url = (compare === 0 || compare === 1) ? "https://app.mgtv.com/mgmp-share/?appid=".concat(config_1.SYSTEM_INFO.appid, "&host=mgtv&path=page/index?") : "https://app.mgtv.com/mgmp-share/?appid=".concat(config_1.SYSTEM_INFO.appid, "&host=mgtv&path=");
                        console.info({
    ...
    SdkMgtv.prototype.rewardedVideoAd = function (data, _a) {
        var _b, _c;
        var complete = _a.complete, fail = _a.fail, onShow = _a.onShow;
        return __awaiter(this, void 0, void 0, function () {
                        ...
                        if (!this._rewardedVideoAd) {
                            ...
                            onError = function (err) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    ...
                                    error = (0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_ad', err);
                                    complete(error);
                                    fail && fail(error);
                                    return [2 /*return*/];
                                });
    ...
    SdkMgtv.prototype.reportScene = function (params, _a) {
        ...
        mgtv.reportScene(__assign(__assign({}, params), { success: function () {
                ...
                complete((0, utils_2.handleTrackError)(PLATFORM, '', err));
            } }));
    };
                    ...
                    success: function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    _a.trys.push([0, 2, , 3]);
                                    return [4 /*yield*/, (0, social_1.opendataAesdecodeApi)({
                                            iv: params.iv,
                                ...
                                case 2:
                                    err_6 = _a.sent();
                                    complete((0, utils_2.handleTrackError)(PLATFORM, '', err_6));
                                    return [3 /*break*/, 3];
                                case 3: return [2 /*return*/];
                            }
                        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(mgtv.getSetting)];
                    case 2:
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(mgtv.authorize, { scope: scope })];
                    case 4:
                        // undefined 代表用户未授权且第一次登陆
                        _a.sent();
                        (callback === null || callback === void 0 ? void 0 : callback.complete) && callback.complete({ code: 0 });
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(mgtv.showModal, {
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(mgtv.openSetting)];
                    case 8:
                        openSetting = _a.sent();
                    ...
                    case 11:
                        err_7 = _a.sent();
                        (callback === null || callback === void 0 ? void 0 : callback.complete) && callback.complete((0, utils_2.handleTrackError)(PLATFORM, '', err_7));
                        return [2 /*return*/, false];
                    case 12: return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6:
                        ...
                        return [2 /*return*/, (0, utils_2.handleTrackError)(PLATFORM, '', err_8)];
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 2:
                        ...
                        (0, stOffset_1.setupStOffsetRefreshForMiniGame)(typeof mgtv !== 'undefined' ? mgtv : null, apis_1.getServerTime);
                        // 检查是否需要激活
                    ...
                    case 3:
                        err_9 = _j.sent();
                        error = __assign(__assign({}, (err_9 || {})), { msg: '初始化错误，或未初始化', code: const_1.COMMON_ERROR_CODE.INIT_PARAMS_ERROR, thirdcode: err_9.code || err_9.errCode, message: err_9.message || err_9.msg || err_9.errMsg, thirdmsg: err_9.message || err_9.msg || err_9.errMsg });
    ...
    SdkMgtv.prototype.checkNeedActivate = function () {
        return __awaiter(this, void 0, void 0, function () {
            var activeResult, source_ad, distinct_id, req, result, err_10;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_11 = _a.sent();
                        callback.complete((0, utils_2.handleTrackError)(PLATFORM, '', err_11));
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
                }
            });
...
exports.default = SdkMgtv;
//# sourceMappingURL=index.mgtv.js.map