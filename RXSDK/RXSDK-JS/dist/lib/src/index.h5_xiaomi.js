...
var SdkH5Xiaomi = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _d.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(qg.getUserInfo, {})];
                    case 1:
                        userInfoResult = _d.sent();
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(qg.login, {})];
                    case 2:
                        loginResult = _d.sent();
    ...
    SdkH5Xiaomi.prototype.login = function (params, callback) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user_source, source_ad, distinct_idLocal, distinct_id, now, reqLogin, queryJson, userInfoResult, loginResult, e_1, _k, custom_ext, rest_ext, loginTokenRx, reflowEnabled, loginRx, err_1;
            return __generator(this, function (_l) {
                switch (_l.label) {
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 5];
                    case 5:
                        (0, utils_2.customSetStorageSync)('rx_xiaomi_login_session', loginResult.data.session);
                        (0, utils_2.customSetStorageSync)('rx_xiaomi_login_appAccountId', loginResult.data.appAccountId);
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    ...
                    case 1:
                        ...
                        reqOrder = __assign(__assign({}, params), { currency: params.currency || 'CNY', openid: config_1.USER_INFO.openid, sub_channel_id: config_1.USER_INFO === null || config_1.USER_INFO === void 0 ? void 0 : config_1.USER_INFO.subchannelid, is_debug: params.is_debug || 0, env: params.env || 0, ext: {
                                'session': (0, utils_2.customGetStorageSync)('rx_xiaomi_login_session'),
                                'appAccountId': "".concat((0, utils_2.customGetStorageSync)('rx_xiaomi_login_app'))
                            } });
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(qg.pay, {
                                orderInfo: {
                        ...
                        if (!this._rewardedVideoAd) {
                            ...
                            onError_1 = function (err) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    ...
                                    // 激励视频广告Error事件
                                    console.log(err);
                                    _error = (0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_ad', err);
                                    complete(_error);
                                    fail && fail(_error);
                                    return [2 /*return*/];
                                });
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 2:
                        ...
                        console.log((0, utils_2.customGetStorageSync)('rx-init-params'));
                        return [3 /*break*/, 4];
                    case 3:
                        err_6 = _j.sent();
    ...
    SdkH5Xiaomi.prototype.saveToDestop = function (message, callback) {
        qg.getShortcut().hasInstalled({
                ...
                if (!ret) {
                    qg.getShortcut().install({
                        ...
                        fail: function (ret) {
                            ...
                            if (callback) {
                                callback.complete((0, utils_3.handleError)(err));
                            }
                        }
                    });
                }
            ...
            fail: function (ret) {
                if (callback) {
                    callback.complete((0, utils_3.handleError)(ret, ret.code));
                }
            }
        });
    };
    SdkH5Xiaomi.prototype.exit = function (callback) {
        qg.exitApplication({
            ...
            fail: function (ret) {
                if (callback) {
                    callback.complete((0, utils_3.handleError)(ret));
                }
            }
        });
    };
...
exports.default = SdkH5Xiaomi;
//# sourceMappingURL=index.h5_xiaomi.js.map