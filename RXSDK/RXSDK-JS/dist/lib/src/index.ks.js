...
function stringToBytes(str) {
    ...
    for (var i = 0; i < str.length; i++) {
        ...
        if (charCode < 0x80) {
            ...
            i++;
            var surrogate = ((charCode & 0x3ff) << 10) | (str.charCodeAt(i) & 0x3ff);
...
function bytesToBase64(bytes) {
    ...
    for (var i = 0; i < bytes.length; i += 3) {
        var chunk = (bytes[i] << 16) | ((i + 1 < bytes.length ? bytes[i + 1] : 0) << 8) | (i + 2 < bytes.length ? bytes[i + 2] : 0);
...
function base64ToBytes(base64) {
    ...
    for (var i = 0; i < base64Length; i += 4) {
        var chunk = (base64Chars.indexOf(base64[i]) << 18) |
...
function bytesToString(bytes) {
    ...
    for (var i = 0; i < bytes.length; i++) {
        ...
        if (byte < 0x80) {
            ...
            var charCode = ((byte & 0x1f) << 6) | (bytes[++i] & 0x3f);
            str += String.fromCharCode(charCode);
        }
        else if (byte < 0xf0) {
            var charCode = ((byte & 0x0f) << 12) | ((bytes[++i] & 0x3f) << 6) | (bytes[++i] & 0x3f);
            str += String.fromCharCode(charCode);
        }
        else {
            var surrogate = ((byte & 0x07) << 18) | ((bytes[++i] & 0x3f) << 12) | ((bytes[++i] & 0x3f) << 6) | (bytes[++i] & 0x3f);
            var high = 0xd800 | ((surrogate >> 10) & 0x3ff);
            var low = 0xdc00 | (surrogate & 0x3ff);
...
function base64ToJson(base64) {
    ...
    var jsonStr = bytesToString(bytes);
...
var SdkKs = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.ksLoginParamsCheck, callback, params)];
                    case 1:
                        _a.sent();
                        ...
                        reqLogin_1 = __assign(__assign(__assign({}, (0, is_1.omit)(params)), user_source), { distinct_id: distinct_id, ts: now });
                        try {
                            ...
                            return __generator(this, function (_f) {
                                switch (_f.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, (0, apis_1.loginByCredentialApi)(this.ActivePrefix(reqLogin_1))];
                                    case 1:
                                        loginRx = _f.sent();
                                        ...
                                        console.log('rxToken', (0, utils_2.customGetStorageSync)('rxToken'));
                                        try {
                                    ...
                                    case 2:
                                        err_2 = _f.sent();
                                        callback.complete((0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_login', err_2, const_1.COMMON_ERROR_CODE.LOGIN_FAIL));
                                        return [3 /*break*/, 3];
                        ...
                        if (params.login_openid) {
                            ks.login({
                                success: function (res) { return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_c) {
                                        switch (_c.label) {
                                            case 0:
                                                _c.trys.push([0, 2, , 3]);
                                                return [4 /*yield*/, (0, apis_1.loginByTokenApi)(this.ActivePrefix(reqLogin_1))];
                                            case 1:
                                            ...
                                            case 2:
                                                err_3 = _c.sent();
                                                callback.complete((0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_login', err_3));
                                                return [3 /*break*/, 3];
                                            case 3: return [2 /*return*/];
                                        }
                                    });
                                ...
                                fail: function (err) {
                                    callback.complete((0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_login', err));
                                }
                            });
                        }
                        else {
                            ks.login({
                                ...
                                fail: function (err) {
                                    callback.complete((0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_login', err, const_1.COMMON_ERROR_CODE.LOGIN_FAIL));
                                }
                            });
                        }
                        return [3 /*break*/, 3];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_0) {
                switch (_0.label) {
                    ...
                    case 1:
                        _0.trys.push([1, 6, , 7]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.ksPayCheckParams, callback, params)];
                    case 2:
                        _0.sent();
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, (0, apis_1.postPayData)((_c = result_1.data) === null || _c === void 0 ? void 0 : _c.notify_url, {
                    ...
                    case 5:
                        ...
                        ks.requestGamePayment(__assign(__assign({}, gamePayParams), { success: function (res) {
                                ...
                                callback.complete((0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_pay', err, const_1.COMMON_ERROR_CODE.PAY_ERROR));
                            } }));
                        return [3 /*break*/, 7];
                    case 6:
                        err_4 = _0.sent();
                        callback.complete((0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_pay', err_4, const_1.COMMON_ERROR_CODE.PAY_ERROR));
                        return [3 /*break*/, 7];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        err_5 = _e.sent();
                        callback.complete((0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_share', err_5));
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err_6 = _a.sent();
                        callback && callback.complete((0, utils_2.handleTrackError)(PLATFORM, '', err_6));
                ...
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        if (rewardedVideoAd) {
                            ...
                            _error = (0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_ad', {
                                code: -1,
                                data: null,
                                msg: '创建激励视频组件失败',
                                isEnded: false
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6:
                        ...
                        return [2 /*return*/, (0, utils_2.handleTrackError)(PLATFORM, '', err_7)];
                    case 7: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 2:
                        ...
                        (0, stOffset_1.setupStOffsetRefreshForMiniGame)(typeof ks !== 'undefined' ? ks : null, apis_1.getServerTime);
                        // 检查是否需要激活
    ...
    SdkKs.prototype.checkNeedActivate = function () {
        return __awaiter(this, void 0, void 0, function () {
            var activeResult, source_ad, distinct_id, req, result, err_9;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        error_5 = _e.sent();
                        (callback === null || callback === void 0 ? void 0 : callback.complete) && callback.complete((0, utils_2.handleTrackError)(PLATFORM, '', error_5));
                        return [3 /*break*/, 5];
                    case 4:
...
exports.default = SdkKs;
//# sourceMappingURL=index.ks.js.map