...
function findSDK(maxDepth) {
    ...
    while (currentWindow && depth < maxDepth) {
        // 检查当前窗口是否存在 IQiYiSDK 对象
        if (currentWindow.IQiYiSDK) {
            return currentWindow.IQiYiSDK;
        }
...
// 使用示例
var IQiYiSDK = findSDK();
if (IQiYiSDK) {
    console.info('找到 IQiYiSDK 对象:', IQiYiSDK);
}
else {
    console.info('未找到 IQiYiSDK 对象');
}
var SdkH5Haluo = /** @class */ (function (_super) {
    ...
    SdkH5Haluo.prototype.login = function (params, callback) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user_source, now, distinct_idLocal, distinct_id, requestParams, queryJson, user_info, reflowEnabled, source_ad, reqLogin, openId, _e, custom_ext, rest_ext, err_1;
    ...
    SdkH5Haluo.prototype.share = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                IQiYiSDK.share({
                    gameShareUrl: params.gameShareUrl,
                    success: function () {
                        callback.complete({ code: 0 });
                    },
                    fail: function (err) {
    ...
    SdkH5Haluo.prototype.getInitConfig = function (callback) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0: return [4 /*yield*/, IQiYiSDK.init({
...
//# sourceMappingURL=index.h5_360.js.map