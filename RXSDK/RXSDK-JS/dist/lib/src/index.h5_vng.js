...
var vngAnalytics_1 = require("./h5/vngAnalytics");
...
var SdkH5Vng = /** @class */ (function (_super) {
                ...
                switch (_j.label) {
                    ...
                    case 2:
                        ...
                        if (!login_info.success) {
                            callback.complete((0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_login', login_info.error));
                            return [2 /*return*/];
                        }
    ...
    SdkH5Vng.prototype.analyticsTrack = function (params, callback) {
        try {
            vngAnalytics_1.default.track(params);
        }
        catch (err) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err_2 = _a.sent();
                        callback.complete((0, utils_2.handleTrackError)(PLATFORM, '', err_2));
                        return [3 /*break*/, 3];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_u) {
                switch (_u.label) {
                    ...
                    case 1: 
                    // 原生充值
                    return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.H5VngPayCheckParams, callback, params)];
                    case 2:
                        // 原生充值
                        _u.sent();
                ...
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.shareSchedulingInit({}, {
                                complete: function () {
                                    if (!stopCallback) {
                                        callback.complete((0, utils_2.handleTrackError)(PLATFORM, '', err_4));
                                    }
                                }
                            })];
                    case 4:
                    ...
                    case 6:
                        ...
                        return [2 /*return*/, (0, utils_2.handleTrackError)(PLATFORM, '', err_4)];
                    case 7: return [2 /*return*/];
                }
            });
        });
...
exports.default = SdkH5Vng;
//# sourceMappingURL=index.h5_vng.js.map