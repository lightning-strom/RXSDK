...
var SdkH5Baidu = /** @class */ (function (_super) {
    __extends(SdkH5Baidu, _super);
    function SdkH5Baidu(initParams) {
        ...
        _this.talkType = {
            SECRET: 'secret',
            POP: 'popwindow',
            RAISEPAY: 'raisepay' //唤起支付
        };
        // 口令传递
        _this.secretData = {};
        // 登录必要参数
        _this.loginMandatory = ['api_key', 'user_id', 'server_id', 'cm_flag', 'timestamp', 'sign'];
        // 初始化url参数
        _this.initUrlParams = {};
        // 百度页游嵌入式充值相关
        _this.payMessageHandler = null;
        Object.assign(config_1.SYSTEM_INFO, config_2.SYSTEM_INFO, __assign({}, initParams));
        _this.initBaiduPayMessageListener();
        _this.getInitConfig({ complete: initParams.complete });
        return _this;
    }
    /**
     * 初始化百度页游嵌入式充值消息监听
     * 监听来自父页面的 secret 消息，获取 origin 和 token
     */
    SdkH5Baidu.prototype.initBaiduPayMessageListener = function () {
        var _this = this;
        this.payMessageHandler = function (event) {
            var _a, _b;
            try {
                console.log(event, 'data==========>');
                // 口令传递
                if (((_a = event === null || event === void 0 ? void 0 : event.data) === null || _a === void 0 ? void 0 : _a.action) === ((_b = _this === null || _this === void 0 ? void 0 : _this.talkType) === null || _b === void 0 ? void 0 : _b.SECRET)) {
                    _this.secretData = event.data;
                }
            }
            catch (error) {
                console.warn('处理百度页游消息时出错:', error);
            }
        };
        window.addEventListener('message', this.payMessageHandler);
    };
    SdkH5Baidu.prototype.login = function (params, callback) {
        var _a, _b, _c, _d;
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        requestParams = __assign({ ts: now, method: params.method || 'baiduh5', distinct_id: distinct_id, ext: params.ext }, user_source);
                        try {
    ...
    // 支付
    SdkH5Baidu.prototype.pay = function (params, callback) {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        return __awaiter(this, void 0, void 0, function () {
            var reqOrder, result, postData, err_2;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        _j.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.H5NewBaiduPayCheckParams, callback, params)];
                    case 1:
                        _j.sent();
                    ...
                    case 2:
                        result = _j.sent();
                        postData = {
                            token: ((_a = this.secretData) === null || _a === void 0 ? void 0 : _a.token) || '945a7c1579a8aad460a5dcb7bfee927a',
                            action: (_b = this.talkType) === null || _b === void 0 ? void 0 : _b.POP,
                            data: {
                                gameId: (params === null || params === void 0 ? void 0 : params.gameId) || '',
                                cpServerId: 1,
                                activeAccount: (_d = (_c = result === null || result === void 0 ? void 0 : result.data) === null || _c === void 0 ? void 0 : _c.ext) === null || _d === void 0 ? void 0 : _d.amount,
                                roleId: (_f = (_e = result === null || result === void 0 ? void 0 : result.data) === null || _e === void 0 ? void 0 : _e.ext) === null || _f === void 0 ? void 0 : _f.order_no,
                                cpExtra: "order_no=".concat((_h = (_g = result === null || result === void 0 ? void 0 : result.data) === null || _g === void 0 ? void 0 : _g.ext) === null || _h === void 0 ? void 0 : _h.order_no) //补充信息，非必填。在支付完成回调时，将以cp_extra字段原样返回
                            }
                        };
                        // 发送postMessage
                        window.top && window.top.window.postMessage(postData, '*');
    ...
    // 分享
    SdkH5Baidu.prototype.share = function (callback) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Baidu.prototype.schedulingAction = function (params, callback) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
    ...
    //获得分享内容
    SdkH5Baidu.prototype.getAdShareData = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Baidu.prototype.rewardedVideoAd = function (_a) {
        var complete = _a.complete;
    };
    SdkH5Baidu.prototype.setScheuleReportProps = function (data) {
        var _a, _b, _c, _d, _e, _f, _g, _h;
    ...
    // 获得公共属性
    SdkH5Baidu.prototype.getPublicProperties = function () {
     ...
     */
    SdkH5Baidu.prototype.setPublicProperties = function (params) {
     ...
     * 修改设置的公共数据。
     */
    SdkH5Baidu.prototype.updatePublicProperties = function (params) {
        if (!(0, is_1.isObject)(params)) {
            var error = new Error('params must be object');
            error.code = const_1.COMMON_ERROR_CODE.PAY_PARAMS_ERROR;
            return (0, utils_2.handleTrackError)(PLATFORM, '', error);
     ...
     * 删除公共属性
     */
    SdkH5Baidu.prototype.deletePublicProperties = function (params) {
        try {
            var cache = (0, utils_2.customGetStorageSync)('rx_public_props');
            // @ts-ignore
    ...
    //获得分享内容
    SdkH5Baidu.prototype.getShareData = function (params, callback, stopCallback) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    // 获取埋点调度
    SdkH5Baidu.prototype.getShareScheduling = function (params) {
    ...
    // 分享调度初始化
    SdkH5Baidu.prototype.shareSchedulingInit = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var req, res, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    // 看广告完成上报
    SdkH5Baidu.prototype.shareSchedulingReport = function (params, callback) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Baidu.prototype.getInitConfig = function (callback) {
    ...
    SdkH5Baidu.prototype.publicSubchannelCheck = function (res) {
        var _a, _b;
        try {
    ...
    // 获取归因数据
    SdkH5Baidu.prototype.getAttributionData = function () {
    ...
    SdkH5Baidu.prototype.checkNeedActivate = function () {
        return __awaiter(this, void 0, void 0, function () {
     ...
     *
     */
    SdkH5Baidu.prototype.loopGetPublicProps = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
    ...
    //格式化queryString
    SdkH5Baidu.prototype.getLoginQsAndGenerateStruct = function () {
        var _a;
        var universal = (0, utils_2.getSearchQueries)();
        var user_source = {};
    ...
    SdkH5Baidu.prototype.ActivePrefix = function (reqParams) {
     ...
     */
    SdkH5Baidu.prototype.setSubChannelId = function (subChannelId) {
        try {
    ...
    SdkH5Baidu.prototype.loadScript = function (url) {
    ...
    //商业广告
    SdkH5Baidu.prototype.getAllBusinessData = function (callback) {
        return __awaiter(this, void 0, void 0, function () {
            var data, result;
            return __generator(this, function (_a) {
                try {
    ...
    // 条件获取商业化窗口数据
    SdkH5Baidu.prototype.getBusinessData = function (params, callback) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
    ...
    // 更新商业化窗口数据
    SdkH5Baidu.prototype.refreshBusinessData = function (callback, isRecord) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Baidu.prototype.dispatchBusinessWindowsQueue = function () {
        return __awaiter(this, void 0, void 0, function () {
            var execute;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    // 商业化下单
    SdkH5Baidu.prototype.requestBusinessOrder = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var result, err_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SdkH5Baidu.prototype.clearPromoterTimer = function () {
    ...
    // 启动定时器
    SdkH5Baidu.prototype.startPromoterTimer = function (callback, autoRefresh) {
        var _this = this;
    ...
    // 获取福利码
    SdkH5Baidu.prototype.getPromoDisplayKEY = function (callback, autoRefresh, immediately) {
        var _this = this;
    ...
    // 兑换福利码
    SdkH5Baidu.prototype.exchangePromoCDKEY = function (cdkey, callback) {
    ...
    SdkH5Baidu.prototype.checkIsPromoter = function () {
        return this.is_promoter;
    };
    return SdkH5Baidu;
}(SdkCommon_1.default));
exports.default = SdkH5Baidu;
//# sourceMappingURL=index.new_h5_baidu.js.map