...
var SdkJd = /** @class */ (function (_super) {
    ...
    SdkJd.prototype.createUserInfoButton = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.jdUserInfoCheckParams, callback, params)];
                    case 1:
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        _h.trys.push([0, 7, , 8]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.jdLoginParamsCheck, callback, params)];
                    case 1:
                        _h.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.jdPayCheckParams, callback, params)];
                    case 2:
                        _c.sent();
                ...
                switch (_16.label) {
                    ...
                    case 1:
                        ...
                        if (landingPageUrl) {
                            ...
                            urlQuery = utils_1.qs.stringify({
                                appid: params.appid,
                                vapptype: params.vapptype,
                                scene: params.scene || '',
                                param: encodeURIComponent(JSON.stringify(utils_1.qs.parse(query) || '')),
                                platform: 'jd'
                            });
                    ...
                    case 2:
                        ...
                        closeCallback = function (res) {
                            ...
                            if (res.errCode == 0) {
                                ...
                                complete((0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_ad', res));
                            }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(jd.getSetting)];
                    case 2:
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(jd.authorize, { scope: scope })];
                    case 4:
                        // undefined 代表用户未授权且第一次登陆
                        _a.sent();
                        (callback === null || callback === void 0 ? void 0 : callback.complete) && callback.complete({ code: 0 });
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(jd.showModal, {
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(jd.openSetting)];
                    case 8:
                        openSetting = _a.sent();
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 2:
                        ...
                        (0, stOffset_1.setupStOffsetRefreshForMiniGame)(typeof jd !== 'undefined' ? jd : null, apis_1.getServerTime);
                        // 检查是否需要激活
...
exports.default = SdkJd;
//# sourceMappingURL=index.jd.js.map