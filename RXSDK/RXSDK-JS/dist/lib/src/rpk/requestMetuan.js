...
var retryRequest = function (options, resolve, reject) {
    ...
    (0, utils_2.printLog)("options", JSON.stringify(options));
    wx.request(__assign(__assign({}, options), { header: header, data: options.data, success: function (res) {
            (0, utils_2.printLog)("".concat(options.url));
            (0, utils_2.printLog)("res", JSON.stringify(res.data));
            resolve(res.data);
        }, fail: function (res) {
            (0, utils_2.printLog)("".concat(options.url));
...
var myRequest = function (options) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        try {
            ...
            (0, utils_1.trackEncrypt)(options, 'meituan', key);
        ...
        wx.request(__assign(__assign({}, options), { data: data, success: function (res) {
                ...
                if ([302015, 302016].includes((_a = res.data) === null || _a === void 0 ? void 0 : _a.code)) {
                    ...
                    (0, utils_1.trackDecrypt)(options, res, 'meituan', key);
                    retryRequest(options, resolve, reject);
                }
                else {
                    ...
                    if (isAes && data_1) {
                        try {
                            if (((_d = res.data) === null || _d === void 0 ? void 0 : _d.code) === 0) {
                                ...
                                (0, utils_2.printLog)("".concat(options.url));
                                (0, utils_2.printLog)("res", JSON.stringify(result));
                                resolve(result);
                            }
                            else {
                                resolve(res.data);
...
//# sourceMappingURL=requestMetuan.js.map