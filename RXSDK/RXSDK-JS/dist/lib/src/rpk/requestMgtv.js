...
var getHeaders = function (path) {
    ...
    if (!accessWhiteSpace.includes(path)) {
        // @ts-ignore
        Reflect.set(header, 'ruixue-accesstoken', (rxToken === null || rxToken === void 0 ? void 0 : rxToken.access) || '');
    }
    if (path == '/v1/passport/token/refresh') {
        console.log('refresh');
        header['ruixue-datacount'] = '1';
        // @ts-ignore
        header['ruixue-refreshtoken'] = rxToken === null || rxToken === void 0 ? void 0 : rxToken.refresh;
    }
    ...
    if ((0, utils_1.checkNeedAesEncrypt)(path)) {
        header['ruixue-encipher'] = '1';
        header['ruixue-devicecode'] = devicecode;
        header['ruixue-version'] = config_1.SYSTEM_INFO.__RX_SDK_VERSION;
        header['ruixue-platformid'] = '4';
    }
    if (config_1.SYSTEM_INFO.region_tag) {
        header['ruixue-region'] = "".concat(config_1.SYSTEM_INFO.region_tag);
    }
    if (config_1.SYSTEM_INFO.cp_role_id) {
        header['ruixue-cp-role-id'] = "".concat(config_1.SYSTEM_INFO.cp_role_id);
    }
    return header;
};
var retryRequest = function (options, resolve, reject) {
    ...
    mgtv.request(__assign(__assign({}, options), { header: header, data: options.data, success: function (res) {
            (0, utils_2.printLog)("".concat(options.url));
...
var myRequest = function (options) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        try {
            ...
            (0, utils_1.trackEncrypt)(options, 'mgtv', key);
            retryRequest(options, resolve, reject);
            return;
        }
        console.info(__assign(__assign({}, options), { data: data }));
        mgtv.request(__assign(__assign({}, options), { data: data, success: function (res) {
                var _a, _b, _c, _d;
                if ([302015, 302016].includes((_a = res.data) === null || _a === void 0 ? void 0 : _a.code)) {
                    ...
                    (0, utils_1.trackDecrypt)(options, res, 'mgtv', key);
                    retryRequest(options, resolve, reject);
                }
                else {
...
function doRequest(options, urlIndex, refreshNum, enableHttpDNS) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var path, error, header, url, res, msg, error, e_1;
...
//# sourceMappingURL=requestMgtv.js.map