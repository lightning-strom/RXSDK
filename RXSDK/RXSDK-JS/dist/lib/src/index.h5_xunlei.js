...
var PLATFORM = 'minigame_xunlei';
var SdkH5Xunlei = /** @class */ (function (_super) {
    __extends(SdkH5Xunlei, _super);
    function SdkH5Xunlei(initParams) {
        ...
        if (window.XL_GAME) {
            ...
            _this.loadScript('https://static2-youxi.a.88cdn.com/backend/xl-lib/xl-game.min.2.2.0.js')
                .then(function () {
                _this.getInitConfig({ complete: initParams.complete });
            })
                .catch(function (err) {
    ...
    // 游戏横屏
    SdkH5Xunlei.prototype.changeRotate = function (type) {
        // type为0是游戏画面切换为横屏，type为1是游戏画面切换为竖屏
        XL_GAME.callApp('changeRotate', { type: type });
    };
    // 新增区服同步
    SdkH5Xunlei.prototype.syncServer = function (params, callback) {
    };
    // 更新区服同步
    SdkH5Xunlei.prototype.updateServer = function (params, callback) {
    };
    // 消息同步
    SdkH5Xunlei.prototype.messageSync = function (params, callback) {
    };
    // 游戏行为上报
    SdkH5Xunlei.prototype.actionReport = function (params) {
        XL_GAME.callApp('actionReport', {
    ...
    SdkH5Xunlei.prototype.login = function (params, callback) {
        var _a, _b, _c, _d;
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        requestParams = __assign({ ts: now, method: params.method || 'minigame_xunlei', distinct_id: distinct_id, ext: params.ext }, user_source);
                        try {
                    ...
                    case 2:
                        ...
                        reqLogin.ext = __assign(__assign({}, (rest_ext || {})), { authKey: login_info.authKey, server_id: login_info.server_id, userId: login_info.userId, ext: login_info.ext, xlData: login_info.xlData, client: login_info.client });
    ...
    SdkH5Xunlei.prototype.pay = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        result = _a.sent();
                        XL_GAME.callApp('superPay', result.data.ext, function (res) {
                            console.log(res);
                            if (res.errorCode == 0) {
                                ...
                                callback.complete((0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_pay', res));
                            }
                        });
                        return [3 /*break*/, 5];
                    case 4:
    ...
    SdkH5Xunlei.prototype.schedulingAction = function (params, callback) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
    ...
    //获得分享内容
    SdkH5Xunlei.prototype.getAdShareData = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Xunlei.prototype.rewardedVideoAd = function (_a) {
    ...
    SdkH5Xunlei.prototype.setScheuleReportProps = function (data) {
    ...
    // 获得公共属性
    SdkH5Xunlei.prototype.getPublicProperties = function () {
     ...
     */
    SdkH5Xunlei.prototype.setPublicProperties = function (params) {
     ...
     * 修改设置的公共数据。
     */
    SdkH5Xunlei.prototype.updatePublicProperties = function (params) {
        if (!(0, is_1.isObject)(params)) {
            var error = new Error('params must be object');
            error.code = const_1.COMMON_ERROR_CODE.PAY_PARAMS_ERROR;
            return (0, utils_2.handleTrackError)(PLATFORM, '', error);
     ...
     * 删除公共属性
     */
    SdkH5Xunlei.prototype.deletePublicProperties = function (params) {
        try {
            var cache = (0, utils_2.customGetStorageSync)('rx_public_props');
            // @ts-ignore
    ...
    //获得分享内容
    SdkH5Xunlei.prototype.getShareData = function (params, callback, stopCallback) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    // 获取埋点调度
    SdkH5Xunlei.prototype.getShareScheduling = function (params) {
    ...
    // 分享调度初始化
    SdkH5Xunlei.prototype.shareSchedulingInit = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var req, res, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    // 看广告完成上报
    SdkH5Xunlei.prototype.shareSchedulingReport = function (params, callback) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Xunlei.prototype.getInitConfig = function (callback) {
    ...
    SdkH5Xunlei.prototype.publicSubchannelCheck = function (res) {
        var _a, _b;
        try {
    ...
    // 获取归因数据
    SdkH5Xunlei.prototype.getAttributionData = function () {
    ...
    SdkH5Xunlei.prototype.checkNeedActivate = function () {
        return __awaiter(this, void 0, void 0, function () {
     ...
     *
     */
    SdkH5Xunlei.prototype.loopGetPublicProps = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
    ...
    //格式化queryString
    SdkH5Xunlei.prototype.getLoginQsAndGenerateStruct = function () {
        var _a;
        var universal = (0, utils_2.getSearchQueries)();
        var user_source = {};
    ...
    SdkH5Xunlei.prototype.ActivePrefix = function (reqParams) {
     ...
     */
    SdkH5Xunlei.prototype.setSubChannelId = function (subChannelId) {
        try {
    ...
    SdkH5Xunlei.prototype.loadScript = function (url) {
    ...
    //商业广告
    SdkH5Xunlei.prototype.getAllBusinessData = function (callback) {
        return __awaiter(this, void 0, void 0, function () {
            var data, result;
            return __generator(this, function (_a) {
                try {
    ...
    // 条件获取商业化窗口数据
    SdkH5Xunlei.prototype.getBusinessData = function (params, callback) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
    ...
    // 更新商业化窗口数据
    SdkH5Xunlei.prototype.refreshBusinessData = function (callback, isRecord) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Xunlei.prototype.dispatchBusinessWindowsQueue = function () {
        return __awaiter(this, void 0, void 0, function () {
            var execute;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    // 商业化下单
    SdkH5Xunlei.prototype.requestBusinessOrder = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var result, err_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SdkH5Xunlei.prototype.clearPromoterTimer = function () {
    ...
    // 启动定时器
    SdkH5Xunlei.prototype.startPromoterTimer = function (callback, autoRefresh) {
        var _this = this;
    ...
    // 获取福利码
    SdkH5Xunlei.prototype.getPromoDisplayKEY = function (callback, autoRefresh, immediately) {
        var _this = this;
    ...
    // 兑换福利码
    SdkH5Xunlei.prototype.exchangePromoCDKEY = function (cdkey, callback) {
    ...
    SdkH5Xunlei.prototype.checkIsPromoter = function () {
        return this.is_promoter;
    };
    return SdkH5Xunlei;
}(SdkCommon_1.default));
exports.default = SdkH5Xunlei;
//# sourceMappingURL=index.h5_xunlei.js.map