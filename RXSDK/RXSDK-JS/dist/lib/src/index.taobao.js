...
var SdkTaobao = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(my.authorize, { scopes: 'scope.userInfo' })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(my.getAuthUserInfo, { scopes: 'scope.userInfo' })];
                    case 2:
    ...
    SdkTaobao.prototype.login = function (params, callback) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user_source, source_ad, distinct_idLocal, distinct_id, now, reqLogin, loginTokenRx, reflowEnabled, loginUserInfoResult, e_1, _g, custom_ext, rest_ext, loginRx, err_1;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        _h.trys.push([0, 11, , 12]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.taobaoLoginParamsCheck, callback, params)];
                    case 1:
                        _h.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _d.trys.push([1, 5, , 6]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.taobaoPayCheckParams, callback, params)];
                    case 2:
                        _d.sent();
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(my.tb.virtualTrade, {
                ...
                switch (_a.label) {
                    case 0:
                        onShow = function () { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                if (this.shareFlag && this.shareFlag == (0, utils_2.customGetStorageSync)('shareFlag')) {
                                    callback.complete({ code: 0 });
                                    this.shareFlag = 0;
                                    (0, utils_2.removeStorageSync)('shareFlag');
                                }
                                return [2 /*return*/];
                            });
                        }); };
                    ...
                    case 1:
                        ...
                        sdk.shareApp({
                            ...
                            querys: utils_1.qs.parse((params === null || params === void 0 ? void 0 : params.query) || '')
                        })
                            .catch(function (err) {
                            callback.complete((0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_share', err));
                        });
                        this.shareFlag = Date.now();
                        (0, utils_2.customSetStorageSync)('shareFlag', this.shareFlag);
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 2:
                        ...
                        config_1.SYSTEM_INFO.CP_OF = false;
...
exports.default = SdkTaobao;
//# sourceMappingURL=index.taobao.js.map