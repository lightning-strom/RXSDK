...
var PLATFORM = 'minigame_aiweiyou';
var SdkH5Awy = /** @class */ (function (_super) {
    __extends(SdkH5Awy, _super);
    function SdkH5Awy(initParams) {
        ...
        if (window.AWY_SDK) {
            ...
            _this.loadScript('https://cdn.11h5.com/static/js/sdk.min.js')
                .then(function () {
                _this.initAwySdk();
                _this.getInitConfig({ complete: initParams.complete });
            })
    ...
    SdkH5Awy.prototype.initAwySdk = function () {
        var _this = this;
        window.AWY_SDK.config(config_1.SYSTEM_INFO.gameId, function () {
            if (typeof _this.handleSdkShareCallback == 'function') {
                _this.handleSdkShareCallback({
                    code: 0,
                    msg: '分享成功'
                });
                _this.handleSdkShareCallback = null;
            }
        });
    };
    SdkH5Awy.prototype.login = function (params, callback) {
        var _a, _b, _c, _d;
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 2:
                        ...
                        reqLogin.ext = __assign(__assign({}, (rest_ext || {})), { user_token: login_info.token });
    ...
    // 支付
    SdkH5Awy.prototype.pay = function (params, callback) {
        var _a, _b, _c, _d;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        _e.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.H5AwyPayCheckParams, callback, params)];
                    case 2:
                        _e.sent();
                    ...
                    case 3:
                        result = _e.sent();
                        window.AWY_SDK.pay({
                            pid: (_a = result === null || result === void 0 ? void 0 : result.data) === null || _a === void 0 ? void 0 : _a.ext.pid,
                            serverid: (_b = result === null || result === void 0 ? void 0 : result.data) === null || _b === void 0 ? void 0 : _b.ext.serverid,
                            txid: result.data.order_no,
                            userdata: (_c = result === null || result === void 0 ? void 0 : result.data) === null || _c === void 0 ? void 0 : _c.ext.userdata,
                            product_count: (_d = result === null || result === void 0 ? void 0 : result.data) === null || _d === void 0 ? void 0 : _d.ext.product_count
                        });
    ...
    SdkH5Awy.prototype.share = function (params, callback) {
        if (params.query) {
            try {
                console.log(utils_1.qs.parse(params.query));
                window.AWY_SDK.shareParams(utils_1.qs.parse(params.query));
            }
            catch (err) {
        ...
        if (params.imageUrl) {
            window.AWY_SDK.shareIcon(params.imageUrl);
        }
        this.handleSdkShareCallback = callback.complete;
        window.AWY_SDK.showShare();
    };
    SdkH5Awy.prototype.setScheuleReportProps = function (data) {
    ...
    // 获得公共属性
    SdkH5Awy.prototype.getPublicProperties = function () {
     ...
     */
    SdkH5Awy.prototype.setPublicProperties = function (params) {
     ...
     * 修改设置的公共数据。
     */
    SdkH5Awy.prototype.updatePublicProperties = function (params) {
        if (!(0, is_1.isObject)(params)) {
            var error = new Error('params must be object');
            error.code = const_1.COMMON_ERROR_CODE.PAY_PARAMS_ERROR;
            return (0, utils_2.handleTrackError)(PLATFORM, '', error);
     ...
     * 删除公共属性
     */
    SdkH5Awy.prototype.deletePublicProperties = function (params) {
        try {
            var cache = (0, utils_2.customGetStorageSync)('rx_public_props');
            // @ts-ignore
    ...
    //获得分享内容
    SdkH5Awy.prototype.getShareData = function (params, callback, stopCallback) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    // 获取埋点调度
    SdkH5Awy.prototype.getShareScheduling = function (params) {
    ...
    // 分享调度初始化
    SdkH5Awy.prototype.shareSchedulingInit = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var req, res, error_1;
    ...
    // 看广告完成上报
    SdkH5Awy.prototype.shareSchedulingReport = function (params, callback) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Awy.prototype.getInitConfig = function (callback) {
    ...
    SdkH5Awy.prototype.publicSubchannelCheck = function (res) {
        var _a, _b;
        try {
    ...
    // 获取归因数据
    SdkH5Awy.prototype.getAttributionData = function () {
    ...
    SdkH5Awy.prototype.checkNeedActivate = function () {
        return __awaiter(this, void 0, void 0, function () {
     ...
     *
     */
    SdkH5Awy.prototype.loopGetPublicProps = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
    ...
    //格式化queryString
    SdkH5Awy.prototype.getLoginQsAndGenerateStruct = function () {
        var _a;
        var universal = (0, utils_2.getSearchQueries)();
        var user_source = {};
    ...
    SdkH5Awy.prototype.ActivePrefix = function (reqParams) {
     ...
     */
    SdkH5Awy.prototype.setSubChannelId = function (subChannelId) {
        try {
    ...
    SdkH5Awy.prototype.loadScript = function (url) {
    ...
    //商业广告
    SdkH5Awy.prototype.getAllBusinessData = function (callback) {
        return __awaiter(this, void 0, void 0, function () {
            var data, result;
            return __generator(this, function (_a) {
                try {
    ...
    // 条件获取商业化窗口数据
    SdkH5Awy.prototype.getBusinessData = function (params, callback) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
    ...
    // 更新商业化窗口数据
    SdkH5Awy.prototype.refreshBusinessData = function (callback, isRecord) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Awy.prototype.dispatchBusinessWindowsQueue = function () {
        return __awaiter(this, void 0, void 0, function () {
            var execute;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    // 商业化下单
    SdkH5Awy.prototype.requestBusinessOrder = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var result, err_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SdkH5Awy.prototype.clearPromoterTimer = function () {
    ...
    // 启动定时器
    SdkH5Awy.prototype.startPromoterTimer = function (callback, autoRefresh) {
        var _this = this;
    ...
    // 获取福利码
    SdkH5Awy.prototype.getPromoDisplayKEY = function (callback, autoRefresh, immediately) {
        var _this = this;
    ...
    // 兑换福利码
    SdkH5Awy.prototype.exchangePromoCDKEY = function (cdkey, callback) {
    ...
    SdkH5Awy.prototype.checkIsPromoter = function () {
        return this.is_promoter;
    };
    return SdkH5Awy;
}(SdkCommon_1.default));
exports.default = SdkH5Awy;
//# sourceMappingURL=index.h5_awy.js.map