...
var SdkAlipay = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(my.getAuthCode, { scopes: 'auth_user' })];
                    case 1:
                        loginResult = _a.sent();
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(my.getAuthUserInfo, { scopes: 'auth_user' })];
                    case 2:
    ...
    SdkAlipay.prototype.login = function (params, callback) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user_source, source_ad, distinct_idLocal, distinct_id, now, reqLogin, queryJson, getLaunchParams, loginResult, loginUserInfoResult, e_1, _g, custom_ext, rest_ext, loginTokenRx, reflowEnabled, loginRx, err_1;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        _h.trys.push([0, 11, , 12]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.alipayLoginParamsCheck, callback, params)];
                    case 1:
                        _h.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.compensateOrderCheckParams, callback, params)];
                    case 1:
                        _a.sent();
                        notify_url = params.notify_url;
                        return [4 /*yield*/, (0, apis_1.postAlipayPayData)(notify_url, params)];
                    case 2:
                        _a.sent();
                    ...
                    case 3:
                        err_2 = _a.sent();
                        if (utils_2.expiredVoucherCode.includes(err_2 === null || err_2 === void 0 ? void 0 : err_2.code)) {
                            // 如果支付回调接口失败的原因是支付凭证已经用过或者是失效，清除补单支付凭证
                            (0, utils_2.removeStorageSync)("rx_".concat(config_1.USER_INFO.tid));
                            callback.complete({
                                code: 0,
                                originErr: (0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_pay', err_2)
                            });
                            return [2 /*return*/];
                        }
            ...
            return __generator(this, function (_o) {
                switch (_o.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.alipayPayCheckParams, callback, params)];
                    case 2:
                        _o.sent();
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, (0, apis_1.postAlipayPayData)(result.data.notify_url, {
                    ...
                    case 5:
                        ...
                        if (my.requestGamePayCoinPayment) {
                            my.requestGamePayCoinPayment({
                                ...
                                extraInfo: utils_1.qs.parse(result.data.transmit_args || ''),
                        ...
                        return [3 /*break*/, 10];
                    case 6: return [4 /*yield*/, (0, utils_1.asyncFunc)(my.requestGamePayment, {
                    ...
                    case 11:
                        err_3 = _o.sent();
                        if ((0, utils_2.isDropOrder)(err_3 === null || err_3 === void 0 ? void 0 : err_3.code)) {
                            payParams = {
                                notify_url: result.data.notify_url,
                                order_no: result.data.order_no
                            };
                            (0, utils_2.customSetStorageSync)("rx_".concat(config_1.USER_INFO.tid), payParams);
                            err_3.data = err_3.data || {};
                            err_3.data = __assign(__assign({}, err_3.data), { payParams: payParams });
                        }
                        callback.complete((0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_pay', err_3));
                        return [3 /*break*/, 12];
                    case 12: return [2 /*return*/];
                }
            });
                            ...
                            my.showSharePanel({
                                complete: function (res) {
                                    ...
                                    if (res.shareResult) {
                                        ...
                                        callback.complete((0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_share', res));
                                    }
                                }
                            });
                        }
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 2:
                        ...
                        (0, stOffset_1.setupStOffsetRefreshForMiniGame)(typeof my !== 'undefined' ? my : null, apis_1.getServerTime);
                        // 检查是否需要激活
...
exports.default = SdkAlipay;
//# sourceMappingURL=index.alipay.js.map