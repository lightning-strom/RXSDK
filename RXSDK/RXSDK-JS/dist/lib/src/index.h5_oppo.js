            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 2:
                        ...
                        Object.assign(config_1.USER_INFO, loginTokenRx.data, { oppo_openid: loginResult.data.token });
                    ...
                    case 4:
                        loginRx = _h.sent();
                        Object.assign(config_1.USER_INFO, loginRx.data, { oppo_openid: loginResult.data.token });
                ...
                switch (_j.label) {
                    case 0:
                        ...
                        reqOrder = __assign(__assign({}, params), { ext: {
                                ...
                                oppo_openid: config_1.USER_INFO.oppo_openid
                            }, currency: params.currency || 'CNY', openid: config_1.USER_INFO.openid, sub_channel_id: config_1.USER_INFO === null || config_1.USER_INFO === void 0 ? void 0 : config_1.USER_INFO.subchannelid, is_debug: params.is_debug || 0, env: params.env || 0 });
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(qg.pay, {
                                ...
                                token: config_1.USER_INFO.oppo_openid,
                    ...
                    case 3:
                        ...
                        if (err_2.code === 305555) {
                            ...
                            err_2.code = const_1.COMMON_ERROR_CODE.PAY_ERROR;
                            err_2.msg = '支付失败';
                        }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, (0, apis_1.channelGatewayAuthApiOppo)(__assign({}, params))];
                    case 1:
                        res = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_7 = _a.sent();
                        callback.complete((0, utils_2.handleTrackError)(PLATFORM, '', error_7));
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
                }
            });
...
exports.default = SdkH5Oppo;
//# sourceMappingURL=index.h5_oppo.js.map