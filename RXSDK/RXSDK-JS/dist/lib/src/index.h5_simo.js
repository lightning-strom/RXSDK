...
var PLATFORM = 'minigame_007';
var SdkH5Simo = /** @class */ (function (_super) {
    __extends(SdkH5Simo, _super);
    function SdkH5Simo(initParams) {
        ...
        if (window.LING_H5_GAME_SDK) {
            _this.getInitConfig({ complete: initParams.complete });
        }
        else {
            _this.loadScript('https://res.007sy.cn/js/gamesdk.js')
                .then(function () {
                _this.getInitConfig({ complete: initParams.complete });
            })
                .catch(function (err) {
    ...
    SdkH5Simo.prototype.login = function (params, callback) {
        var _a, _b, _c, _d;
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        requestParams = __assign({ ts: now, method: params.method || 'minigame_007', distinct_id: distinct_id, ext: params.ext }, user_source);
                        try {
                    ...
                    case 2:
                        ...
                        reqLogin.ext = __assign(__assign({}, (rest_ext || {})), { uid: login_info.uid, auth: login_info.auth, tm: "".concat(login_info.login_time) });
    ...
    SdkH5Simo.prototype.logout = function () {
        LING_H5_GAME_SDK.logout();
    };
    // 角色数据上报
    SdkH5Simo.prototype.upRole = function (params) {
        var login_info = (0, utils_2.getSearchQueries)();
        LING_H5_GAME_SDK.role({
            uid: login_info.uid,
            GAME_ID: login_info.GAME_ID,
            server_id: params.server_id,
            server_name: params.server_name,
            role_action: params.role_action,
            role_id: params.role_id,
            role_name: params.role_name,
            role_level: params.role_level,
            combat_number: params.combat_number,
            timestamp: params.timestamp,
            sign: params.sign
        });
    };
    // 支付
    SdkH5Simo.prototype.pay = function (params, callback) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    ...
                    case 1:
                        _s.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.H5SimoPayCheckParams, callback, params)];
                    case 2:
                        _s.sent();
                    ...
                    case 3:
                        result = _s.sent();
                        LING_H5_GAME_SDK.pay({
                            amount: (_b = (_a = result.data) === null || _a === void 0 ? void 0 : _a.ext) === null || _b === void 0 ? void 0 : _b.amount,
                            GAME_ID: (_d = (_c = result.data) === null || _c === void 0 ? void 0 : _c.ext) === null || _d === void 0 ? void 0 : _d.GAME_ID,
                            product_id: (_f = (_e = result.data) === null || _e === void 0 ? void 0 : _e.ext) === null || _f === void 0 ? void 0 : _f.product_id,
                            props_name: (_h = (_g = result.data) === null || _g === void 0 ? void 0 : _g.ext) === null || _h === void 0 ? void 0 : _h.props_name,
                            cp_order_sn: (_k = (_j = result.data) === null || _j === void 0 ? void 0 : _j.ext) === null || _k === void 0 ? void 0 : _k.cp_order_sn,
                            uid: (_m = (_l = result.data) === null || _l === void 0 ? void 0 : _l.ext) === null || _m === void 0 ? void 0 : _m.uid,
                            timestamp: (_p = (_o = result.data) === null || _o === void 0 ? void 0 : _o.ext) === null || _p === void 0 ? void 0 : _p.timestamp,
    ...
    SdkH5Simo.prototype.share = function () {
    };
    SdkH5Simo.prototype.rewardedVideoAd = function (_a) {
        var complete = _a.complete;
        var call_back_params = {
            watch_ad: {
                success: function (data) {
                    console.log(data);
                    if (data && data.isRewardValid) {
                        complete({
                            code: 0,
                            data: null,
                            msg: '正常播放结束，可以下发游戏奖励',
        ...
        LING_H5_GAME_SDK.config(call_back_params);
        LING_H5_GAME_SDK.watch_ad({});
    };
    SdkH5Simo.prototype.setScheuleReportProps = function (data) {
    ...
    // 获得公共属性
    SdkH5Simo.prototype.getPublicProperties = function () {
     ...
     */
    SdkH5Simo.prototype.setPublicProperties = function (params) {
     ...
     * 修改设置的公共数据。
     */
    SdkH5Simo.prototype.updatePublicProperties = function (params) {
        if (!(0, is_1.isObject)(params)) {
            var error = new Error('params must be object');
            error.code = const_1.COMMON_ERROR_CODE.PAY_PARAMS_ERROR;
            return (0, utils_2.handleTrackError)(PLATFORM, '', error);
     ...
     * 删除公共属性
     */
    SdkH5Simo.prototype.deletePublicProperties = function (params) {
        try {
            var cache = (0, utils_2.customGetStorageSync)('rx_public_props');
            // @ts-ignore
    ...
    //获得分享内容
    SdkH5Simo.prototype.getShareData = function (params, callback, stopCallback) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    // 获取埋点调度
    SdkH5Simo.prototype.getShareScheduling = function (params) {
    ...
    // 分享调度初始化
    SdkH5Simo.prototype.shareSchedulingInit = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var req, res, error_1;
    ...
    // 看广告完成上报
    SdkH5Simo.prototype.shareSchedulingReport = function (params, callback) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Simo.prototype.getInitConfig = function (callback) {
    ...
    SdkH5Simo.prototype.publicSubchannelCheck = function (res) {
        var _a, _b;
        try {
    ...
    // 获取归因数据
    SdkH5Simo.prototype.getAttributionData = function () {
    ...
    SdkH5Simo.prototype.checkNeedActivate = function () {
        return __awaiter(this, void 0, void 0, function () {
     ...
     *
     */
    SdkH5Simo.prototype.loopGetPublicProps = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
    ...
    //格式化queryString
    SdkH5Simo.prototype.getLoginQsAndGenerateStruct = function () {
        var _a;
        var universal = (0, utils_2.getSearchQueries)();
        var user_source = {};
    ...
    SdkH5Simo.prototype.ActivePrefix = function (reqParams) {
     ...
     */
    SdkH5Simo.prototype.setSubChannelId = function (subChannelId) {
        try {
    ...
    SdkH5Simo.prototype.loadScript = function (url) {
    ...
    //商业广告
    SdkH5Simo.prototype.getAllBusinessData = function (callback) {
        return __awaiter(this, void 0, void 0, function () {
            var data, result;
            return __generator(this, function (_a) {
                try {
    ...
    // 条件获取商业化窗口数据
    SdkH5Simo.prototype.getBusinessData = function (params, callback) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
    ...
    // 更新商业化窗口数据
    SdkH5Simo.prototype.refreshBusinessData = function (callback, isRecord) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Simo.prototype.dispatchBusinessWindowsQueue = function () {
        return __awaiter(this, void 0, void 0, function () {
            var execute;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    // 商业化下单
    SdkH5Simo.prototype.requestBusinessOrder = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var result, err_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SdkH5Simo.prototype.clearPromoterTimer = function () {
    ...
    // 启动定时器
    SdkH5Simo.prototype.startPromoterTimer = function (callback, autoRefresh) {
        var _this = this;
    ...
    // 获取福利码
    SdkH5Simo.prototype.getPromoDisplayKEY = function (callback, autoRefresh, immediately) {
        var _this = this;
    ...
    // 兑换福利码
    SdkH5Simo.prototype.exchangePromoCDKEY = function (cdkey, callback) {
    ...
    SdkH5Simo.prototype.checkIsPromoter = function () {
        return this.is_promoter;
    };
    return SdkH5Simo;
}(SdkCommon_1.default));
exports.default = SdkH5Simo;
//# sourceMappingURL=index.h5_simo.js.map