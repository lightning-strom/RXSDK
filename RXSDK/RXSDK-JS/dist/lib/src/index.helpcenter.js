...
var helpcenter_1 = require("@/api/helpcenter");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, (0, helpcenter_1.getMainlayoutApi)()];
                    case 1:
                        result = _b.sent();
                        complete(result);
                        return [3 /*break*/, 3];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, (0, helpcenter_1.getListlayoutApi)(params)];
                    case 1:
                        result = _b.sent();
                        complete(result);
                        return [3 /*break*/, 3];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, (0, helpcenter_1.getInfolayoutApi)(params)];
                    case 1:
                        result = _b.sent();
                        complete(result);
                        return [3 /*break*/, 3];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, (0, helpcenter_1.postResolutionApi)(params)];
                    case 1:
                        result = _b.sent();
                        complete(result);
                        return [3 /*break*/, 3];
...
exports.default = SdkHelpcenter;
//# sourceMappingURL=index.helpcenter.js.map