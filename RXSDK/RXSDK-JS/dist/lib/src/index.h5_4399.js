...
var PLATFORM = 'minigame_4399h5';
var SdkH54399 = /** @class */ (function (_super) {
    __extends(SdkH54399, _super);
    function SdkH54399(initParams) {
        ...
        if (window.H5API) {
            ...
            _this.loadScript('https://cdn.h5wan.4399sj.com/h5web-frame/dist/static/js/api.js')
                .then(function () {
                _this.getInitConfig({ complete: initParams.complete });
            })
                .catch(function (err) {
    ...
    SdkH54399.prototype.login = function (params, callback) {
        var _a, _b, _c, _d;
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        requestParams = __assign({ ts: now, method: params.method || 'minigame_4399h5', distinct_id: distinct_id, ext: params.ext }, user_source);
                        try {
                    ...
                    case 2:
                        ...
                        reqLogin.ext = __assign(__assign({}, (rest_ext || {})), { gameId: login_info.gameId, userId: login_info.userId, userName: login_info.userName, sign: login_info.sign, time: "".concat(login_info.time) });
    ...
    SdkH54399.prototype.pay = function (params, callback) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.H54399PayCheckParams, callback, params)];
                    case 2:
                        _b.sent();
                    ...
                    case 3:
                         ...
                         * @param {String} extra 透传参数，用于充值成功后的服务端回调地址
                         */
                        console.log('支付金额: ', result.data.price + '分');
                        window.H5API.openPay(Math.floor(result.data.price / 100), result.data.order_no, (_a = result.data.ext) === null || _a === void 0 ? void 0 : _a.server, result.data.notify_url);
    ...
    SdkH54399.prototype.share = function () {
        window.H5API.shareGame();
    };
    SdkH54399.prototype.schedulingAction = function (params, callback) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
    ...
    //获得分享内容
    SdkH54399.prototype.getAdShareData = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH54399.prototype.rewardedVideoAd = function (_a) {
         ...
         * @param callback 回调函数
         */
        window.H5API.callPlayAd(function (callData) {
            if (callData.canPlayAd) {
                ...
                complete({
                    code: -2,
                    data: null,
                    msg: "\u4E0D\u53EF\u64AD\u653E\u5E7F\u544A\uFF0C\u5269\u4F59\u6B21\u6570".concat(callData.remain),
                    isEnded: true
                });
            }
        });
    };
    SdkH54399.prototype.setScheuleReportProps = function (data) {
    ...
    // 获得公共属性
    SdkH54399.prototype.getPublicProperties = function () {
     ...
     */
    SdkH54399.prototype.setPublicProperties = function (params) {
     ...
     * 修改设置的公共数据。
     */
    SdkH54399.prototype.updatePublicProperties = function (params) {
        if (!(0, is_1.isObject)(params)) {
            var error = new Error('params must be object');
            error.code = const_1.COMMON_ERROR_CODE.PAY_PARAMS_ERROR;
            return (0, utils_2.handleTrackError)(PLATFORM, '', error);
     ...
     * 删除公共属性
     */
    SdkH54399.prototype.deletePublicProperties = function (params) {
        try {
            var cache = (0, utils_2.customGetStorageSync)('rx_public_props');
            // @ts-ignore
    ...
    //获得分享内容
    SdkH54399.prototype.getShareData = function (params, callback, stopCallback) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    // 获取埋点调度
    SdkH54399.prototype.getShareScheduling = function (params) {
    ...
    // 分享调度初始化
    SdkH54399.prototype.shareSchedulingInit = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var req, res, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    // 看广告完成上报
    SdkH54399.prototype.shareSchedulingReport = function (params, callback) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH54399.prototype.getInitConfig = function (callback) {
    ...
    SdkH54399.prototype.publicSubchannelCheck = function (res) {
        var _a, _b;
        try {
    ...
    // 获取归因数据
    SdkH54399.prototype.getAttributionData = function () {
    ...
    SdkH54399.prototype.checkNeedActivate = function () {
        return __awaiter(this, void 0, void 0, function () {
     ...
     *
     */
    SdkH54399.prototype.loopGetPublicProps = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
    ...
    //格式化queryString
    SdkH54399.prototype.getLoginQsAndGenerateStruct = function () {
        var _a;
        var universal = (0, utils_2.getSearchQueries)();
        var user_source = {};
    ...
    SdkH54399.prototype.ActivePrefix = function (reqParams) {
     ...
     */
    SdkH54399.prototype.setSubChannelId = function (subChannelId) {
        try {
    ...
    SdkH54399.prototype.loadScript = function (url) {
    ...
    //商业广告
    SdkH54399.prototype.getAllBusinessData = function (callback) {
        return __awaiter(this, void 0, void 0, function () {
            var data, result;
            return __generator(this, function (_a) {
                try {
    ...
    // 条件获取商业化窗口数据
    SdkH54399.prototype.getBusinessData = function (params, callback) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
    ...
    // 更新商业化窗口数据
    SdkH54399.prototype.refreshBusinessData = function (callback, isRecord) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH54399.prototype.dispatchBusinessWindowsQueue = function () {
        return __awaiter(this, void 0, void 0, function () {
            var execute;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    // 商业化下单
    SdkH54399.prototype.requestBusinessOrder = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var result, err_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SdkH54399.prototype.clearPromoterTimer = function () {
    ...
    // 启动定时器
    SdkH54399.prototype.startPromoterTimer = function (callback, autoRefresh) {
        var _this = this;
    ...
    // 获取福利码
    SdkH54399.prototype.getPromoDisplayKEY = function (callback, autoRefresh, immediately) {
        var _this = this;
    ...
    // 兑换福利码
    SdkH54399.prototype.exchangePromoCDKEY = function (cdkey, callback) {
    ...
    SdkH54399.prototype.checkIsPromoter = function () {
        return this.is_promoter;
    };
    return SdkH54399;
}(SdkCommon_1.default));
exports.default = SdkH54399;
//# sourceMappingURL=index.h5_4399.js.map