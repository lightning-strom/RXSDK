...
var SdkCommon_1 = require("./h5/SdkCommon");
...
var SdkH5Shandw = /** @class */ (function (_super) {
    ...
    function SdkH5Shandw(initParams) {
        ...
        if (sdw) {
            ...
            initParams.complete((0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_init', {
                code: -1,
                msg: 'sdk 加载失败'
            }));
        }
            ...
            return __generator(this, function (_2) {
                switch (_2.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.H5ShandwPayCheckParams, callback, params)];
                    case 1:
                        // this.payUrlParams = findChannelCodeInHierarchy(this.payMandatory, this.payOptional)
                        _2.sent();
                        ...
                        if (res.result == 1) { //已经实名
                            ...
                            sdw.chooseSDWIdentify(function (res) {
                                ...
                                if (res.result == 1) {
                                    ...
                                    callback.complete((0, utils_2.handleTrackError)(PLATFORM, '', {
                                        code: -1,
                                        msg: '实名认证失败',
                                        data: res
                                    }));
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, apis_1.channelGatewayAuthApi)({ paramsData: paramsData })];
                    case 1:
                        res = _b.sent();
...
exports.default = SdkH5Shandw;
//# sourceMappingURL=index.h5_shandw.js.map