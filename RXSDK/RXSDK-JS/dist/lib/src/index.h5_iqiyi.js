...
var SdkH5Iqiyi = /** @class */ (function (_super) {
    __extends(SdkH5Iqiyi, _super);
    function SdkH5Iqiyi(initParams) {
        ...
        // 登录必要参数
        _this.loginMandatory = ['user_id', 'agent', 'time', 'sign'];
        // 初始化url参数
        _this.initUrlParams = {};
        Object.assign(config_1.SYSTEM_INFO, config_2.SYSTEM_INFO, __assign({}, initParams));
        _this.initUrlParams = findChannelCodeInHierarchy(_this.loginMandatory);
        _this.getInitConfig({ complete: initParams.complete });
        return _this;
    }
    SdkH5Iqiyi.prototype.login = function (params, callback) {
        var _a, _b, _c, _d;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        _f.trys.push([0, 5, , 6]);
                        this.initUrlParams = findChannelCodeInHierarchy(this.loginMandatory);
                        ...
                        requestParams = __assign({ ts: now, method: params.method || 'minigame_iqiyi', distinct_id: distinct_id, ext: params.ext }, user_source);
                        try {
    ...
    // 支付
    SdkH5Iqiyi.prototype.pay = function (params, callback) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l;
        return __awaiter(this, void 0, void 0, function () {
            var reqOrder, result, order_amount, postMessageParams, err_2;
            return __generator(this, function (_m) {
                switch (_m.label) {
                    case 0:
                        _m.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.H5IQiYiPayCheckParams, callback, params)];
                    case 1:
                        _m.sent();
                        if (params.indulge_auth == 1 && !params.age) {
                            throw Error('when indulge_auth equal 1,the age must be required');
                        }
                        reqOrder = __assign(__assign({}, params), { currency: params.currency || 'CNY', sub_channel_id: config_1.USER_INFO === null || config_1.USER_INFO === void 0 ? void 0 : config_1.USER_INFO.subchannelid, is_debug: params.is_debug || 0, env: params.env || 0, openid: config_1.USER_INFO.openid });
                        return [4 /*yield*/, (0, apis_1.orderApi)(reqOrder)];
                    case 2:
                        result = _m.sent();
                        order_amount = Number((_b = (_a = result === null || result === void 0 ? void 0 : result.data) === null || _a === void 0 ? void 0 : _a.ext) === null || _b === void 0 ? void 0 : _b.money) / 100 || 0;
                        postMessageParams = "game_id=".concat((_d = (_c = result === null || result === void 0 ? void 0 : result.data) === null || _c === void 0 ? void 0 : _c.ext) === null || _d === void 0 ? void 0 : _d.game_id, "&user_id=").concat((_f = (_e = result === null || result === void 0 ? void 0 : result.data) === null || _e === void 0 ? void 0 : _e.ext) === null || _f === void 0 ? void 0 : _f.user_id, "&server_id=").concat((_h = (_g = result === null || result === void 0 ? void 0 : result.data) === null || _g === void 0 ? void 0 : _g.ext) === null || _h === void 0 ? void 0 : _h.server_id, "&money=").concat(order_amount, "&extra_param=").concat((_k = (_j = result.data) === null || _j === void 0 ? void 0 : _j.ext) === null || _k === void 0 ? void 0 : _k.extra_param);
                        console.log(postMessageParams, 'postMessageParams', order_amount);
                        // 游戏中可能有多层级嵌套，寻找最上级
                        try {
                            if (window === null || window === void 0 ? void 0 : window.top) {
                                (_l = window === null || window === void 0 ? void 0 : window.top) === null || _l === void 0 ? void 0 : _l.postMessage(postMessageParams, '*');
                            }
                            else {
    ...
    // 分享
    SdkH5Iqiyi.prototype.share = function (callback) {
        var _a, _b, _c, _d, _e;
        return __awaiter(this, void 0, void 0, function () {
            var msg;
            return __generator(this, function (_f) {
                try {
                    msg = { position: "game_share", data: "show" };
                    // 游戏中可能有多层级嵌套，寻找最上级
                    try {
                        if (window === null || window === void 0 ? void 0 : window.top) {
                            (_a = window === null || window === void 0 ? void 0 : window.top) === null || _a === void 0 ? void 0 : _a.postMessage(msg, 'http://togame.pps.tv');
                            (_b = window === null || window === void 0 ? void 0 : window.top) === null || _b === void 0 ? void 0 : _b.postMessage(msg, 'http://togame.iqiyi.com');
                            (_c = window === null || window === void 0 ? void 0 : window.top) === null || _c === void 0 ? void 0 : _c.postMessage(msg, 'http://playgame.pps.tv');
                            (_d = window === null || window === void 0 ? void 0 : window.top) === null || _d === void 0 ? void 0 : _d.postMessage(msg, 'http://playgame.iqiyi.com');
                            (_e = window === null || window === void 0 ? void 0 : window.top) === null || _e === void 0 ? void 0 : _e.postMessage(msg, 'http://playgame2.iqiyi.com');
                        }
                        else {
    ...
    SdkH5Iqiyi.prototype.schedulingAction = function (params, callback) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
    ...
    //获得分享内容
    SdkH5Iqiyi.prototype.getAdShareData = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Iqiyi.prototype.rewardedVideoAd = function (_a) {
        var complete = _a.complete;
    };
    SdkH5Iqiyi.prototype.setScheuleReportProps = function (data) {
    ...
    // 获得公共属性
    SdkH5Iqiyi.prototype.getPublicProperties = function () {
     ...
     */
    SdkH5Iqiyi.prototype.setPublicProperties = function (params) {
     ...
     * 修改设置的公共数据。
     */
    SdkH5Iqiyi.prototype.updatePublicProperties = function (params) {
        if (!(0, is_1.isObject)(params)) {
            var error = new Error('params must be object');
            error.code = const_1.COMMON_ERROR_CODE.PAY_PARAMS_ERROR;
            return (0, utils_2.handleTrackError)(PLATFORM, '', error);
     ...
     * 删除公共属性
     */
    SdkH5Iqiyi.prototype.deletePublicProperties = function (params) {
        try {
            var cache = (0, utils_2.customGetStorageSync)('rx_public_props');
            // @ts-ignore
    ...
    //获得分享内容
    SdkH5Iqiyi.prototype.getShareData = function (params, callback, stopCallback) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    // 获取埋点调度
    SdkH5Iqiyi.prototype.getShareScheduling = function (params) {
    ...
    // 分享调度初始化
    SdkH5Iqiyi.prototype.shareSchedulingInit = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var req, res, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    // 看广告完成上报
    SdkH5Iqiyi.prototype.shareSchedulingReport = function (params, callback) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Iqiyi.prototype.getInitConfig = function (callback) {
    ...
    SdkH5Iqiyi.prototype.publicSubchannelCheck = function (res) {
        var _a, _b;
        try {
    ...
    // 获取归因数据
    SdkH5Iqiyi.prototype.getAttributionData = function () {
    ...
    SdkH5Iqiyi.prototype.checkNeedActivate = function () {
        return __awaiter(this, void 0, void 0, function () {
     ...
     *
     */
    SdkH5Iqiyi.prototype.loopGetPublicProps = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
    ...
    //格式化queryString
    SdkH5Iqiyi.prototype.getLoginQsAndGenerateStruct = function () {
        var _a;
        var universal = (0, utils_2.getSearchQueries)();
        var user_source = {};
    ...
    SdkH5Iqiyi.prototype.ActivePrefix = function (reqParams) {
     ...
     */
    SdkH5Iqiyi.prototype.setSubChannelId = function (subChannelId) {
        try {
    ...
    SdkH5Iqiyi.prototype.loadScript = function (url) {
    ...
    //商业广告
    SdkH5Iqiyi.prototype.getAllBusinessData = function (callback) {
        return __awaiter(this, void 0, void 0, function () {
            var data, result;
            return __generator(this, function (_a) {
                try {
    ...
    // 条件获取商业化窗口数据
    SdkH5Iqiyi.prototype.getBusinessData = function (params, callback) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
    ...
    // 更新商业化窗口数据
    SdkH5Iqiyi.prototype.refreshBusinessData = function (callback, isRecord) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Iqiyi.prototype.dispatchBusinessWindowsQueue = function () {
        return __awaiter(this, void 0, void 0, function () {
            var execute;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    // 商业化下单
    SdkH5Iqiyi.prototype.requestBusinessOrder = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var result, err_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SdkH5Iqiyi.prototype.clearPromoterTimer = function () {
    ...
    // 启动定时器
    SdkH5Iqiyi.prototype.startPromoterTimer = function (callback, autoRefresh) {
        var _this = this;
    ...
    // 获取福利码
    SdkH5Iqiyi.prototype.getPromoDisplayKEY = function (callback, autoRefresh, immediately) {
        var _this = this;
    ...
    // 兑换福利码
    SdkH5Iqiyi.prototype.exchangePromoCDKEY = function (cdkey, callback) {
    ...
    SdkH5Iqiyi.prototype.checkIsPromoter = function () {
        return this.is_promoter;
    };
    return SdkH5Iqiyi;
}(SdkCommon_1.default));
exports.default = SdkH5Iqiyi;
//# sourceMappingURL=index.h5_iqiyi.js.map