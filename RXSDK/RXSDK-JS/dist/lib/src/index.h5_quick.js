...
var SdkH5Quick = /** @class */ (function (_super) {
    ...
    function SdkH5Quick(initParams) {
        ...
        config_1.SYSTEM_INFO.third_channel_code = findChannelCodeInHierarchy();
    ...
    SdkH5Quick.prototype.getQuickChannelCode = function () {
        return config_1.SYSTEM_INFO.third_channel_code;
    };
    SdkH5Quick.prototype.initQuick = function (callback) {
        QuickSDK.init(config_1.SYSTEM_INFO.productCode, config_1.SYSTEM_INFO.productKey, false, callback);
    };
    // 游戏行为上报
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_0) {
                switch (_0.label) {
                    case 0:
                        _0.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.H5QuickPayCheckParams, callback, params)];
                    case 1:
                        _0.sent();
...
exports.default = SdkH5Quick;
//# sourceMappingURL=index.h5_quick.js.map