...
var SdkMeiTuan = /** @class */ (function (_super) {
    ...
    SdkMeiTuan.prototype.pay = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var orderReq, requestMidasPaymentReq, compensateOrderReq, reqOrder, result, res, ext, order_no, requestMidasPaymentParams, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        reqOrder = __assign(__assign({}, params), { currency: 'CNY', openid: config_1.USER_INFO.openid, sub_channel_id: config_1.USER_INFO.subchannelid, is_debug: params.is_debug || 0, env: params.env || 0, pay_type: 'minigame_meituan' });
    ...
    SdkMeiTuan.prototype.share = function (params, callback) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var shareData, onHide, onShow, query;
            var _this = this;
                ...
                try {
                    ...
                    if (((_a = mt === null || mt === void 0 ? void 0 : mt.getSystemInfoSync()) === null || _a === void 0 ? void 0 : _a.SDKVersion) && this.versionCheck((_b = mt === null || mt === void 0 ? void 0 : mt.getSystemInfoSync()) === null || _b === void 0 ? void 0 : _b.SDKVersion, '12.45.200') && (mt === null || mt === void 0 ? void 0 : mt.createCustomAd)) {
                        ...
                        customAd_1.onError(function (res) {
                            ...
                            // 异常需要上报大数据
                            try {
                                (0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_ad', __assign(__assign({}, res), { adErrorType: 'onError' }));
                            }
                            catch (error) { }
                        });
                        // 可以在 onClose 进行监听关闭
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 2:
                        ...
                        (0, stOffset_1.setupStOffsetRefreshForMiniGame)(typeof mt !== 'undefined' ? mt : null, apis_1.getServerTime);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(mt.addShortcut, {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        reportParams = __assign(__assign({}, params), { openid: config_1.USER_INFO.openid });
                        return [4 /*yield*/, (0, apis_1.mtReport)(reportParams)];
                    case 1:
                        result = _a.sent();
                        callback.complete(result);
                        return [3 /*break*/, 3];
...
exports.default = SdkMeiTuan;
//# sourceMappingURL=index.meituan.js.map