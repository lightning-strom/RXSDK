...
exports.transformError = exports.transformResponse = exports.extend = exports.bind = exports.forEach = exports.buildURL = exports.buildFullPath = exports.isAbsoluteURL = exports.combineURLs = exports.combineUrl = exports.mergeConfig = void 0;
function encode(val) {
...
function mergeConfig(config0, config1) {
    if (config0 === void 0) { config0 = {}; }
    if (config1 === void 0) { config1 = {}; }
    return __assign(__assign({}, config0), config1);
}
 ...
 * @param config
 */
function transformError(error, config) {
    /* 微信 */
