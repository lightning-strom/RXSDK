...
var PLATFORM = 'minigame_77';
var SdkH5QQ = /** @class */ (function (_super) {
    __extends(SdkH5QQ, _super);
    function SdkH5QQ(initParams) {
        ...
        if (window.QQSY_SDK) {
            ...
            _this.loadScript("https://app.77sy.com.cn/static/sdk/77sy_sdk.min.js?t=".concat(Date.now()))
                .then(function () {
                _this.getInitConfig({ complete: initParams.complete });
            })
                .catch(function (err) {
    ...
    SdkH5QQ.prototype.getUserInfo = function (callback) {
        QQSY_SDK.getUserInfo(function (data) {
            callback === null || callback === void 0 ? void 0 : callback.complete(data);
        });
    };
    SdkH5QQ.prototype.qqLogin = function () {
    ...
    SdkH5QQ.prototype.login = function (params, callback) {
        var _a, _b, _c, _d;
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        requestParams = __assign({ ts: now, method: params.method || 'minigame_77', distinct_id: distinct_id, ext: params.ext }, user_source);
                        try {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.qqLogin()];
                    case 3:
                        login_info = _f.sent();
                        _e = reqLogin.ext || {}, custom_ext = _e.custom_ext, rest_ext = __rest(_e, ["custom_ext"]);
                        reqLogin.custom_ext = custom_ext || {};
                        reqLogin.ext = __assign(__assign({}, (rest_ext || {})), { uid: "".concat(login_info.uid), token: login_info.token, sign: login_info.sign });
    ...
    SdkH5QQ.prototype.pay = function (params, callback) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.H5QiqiPayCheckParams, callback, params)];
                    case 2:
                        _b.sent();
                    ...
                    case 3:
                        result = _b.sent();
                        QQSY_SDK.pay((_a = result.data) === null || _a === void 0 ? void 0 : _a.ext);
    ...
    SdkH5QQ.prototype.setScheuleReportProps = function (data) {
    ...
    // 获得公共属性
    SdkH5QQ.prototype.getPublicProperties = function () {
     ...
     */
    SdkH5QQ.prototype.setPublicProperties = function (params) {
     ...
     * 修改设置的公共数据。
     */
    SdkH5QQ.prototype.updatePublicProperties = function (params) {
        if (!(0, is_1.isObject)(params)) {
            var error = new Error('params must be object');
            error.code = const_1.COMMON_ERROR_CODE.PAY_PARAMS_ERROR;
            return (0, utils_2.handleTrackError)(PLATFORM, '', error);
     ...
     * 删除公共属性
     */
    SdkH5QQ.prototype.deletePublicProperties = function (params) {
        try {
            var cache = (0, utils_2.customGetStorageSync)('rx_public_props');
            // @ts-ignore
    ...
    //获得分享内容
    SdkH5QQ.prototype.getShareData = function (params, callback, stopCallback) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    // 获取埋点调度
    SdkH5QQ.prototype.getShareScheduling = function (params) {
    ...
    // 分享调度初始化
    SdkH5QQ.prototype.shareSchedulingInit = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var req, res, error_1;
    ...
    // 看广告完成上报
    SdkH5QQ.prototype.shareSchedulingReport = function (params, callback) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5QQ.prototype.getInitConfig = function (callback) {
    ...
    SdkH5QQ.prototype.publicSubchannelCheck = function (res) {
        var _a, _b;
        try {
    ...
    // 获取归因数据
    SdkH5QQ.prototype.getAttributionData = function () {
    ...
    SdkH5QQ.prototype.checkNeedActivate = function () {
        return __awaiter(this, void 0, void 0, function () {
     ...
     *
     */
    SdkH5QQ.prototype.loopGetPublicProps = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
    ...
    //格式化queryString
    SdkH5QQ.prototype.getLoginQsAndGenerateStruct = function () {
        var _a;
        var universal = (0, utils_2.getSearchQueries)();
        var user_source = {};
    ...
    SdkH5QQ.prototype.ActivePrefix = function (reqParams) {
     ...
     */
    SdkH5QQ.prototype.setSubChannelId = function (subChannelId) {
        try {
    ...
    SdkH5QQ.prototype.loadScript = function (url) {
    ...
    //商业广告
    SdkH5QQ.prototype.getAllBusinessData = function (callback) {
        return __awaiter(this, void 0, void 0, function () {
            var data, result;
            return __generator(this, function (_a) {
                try {
    ...
    // 条件获取商业化窗口数据
    SdkH5QQ.prototype.getBusinessData = function (params, callback) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
    ...
    // 更新商业化窗口数据
    SdkH5QQ.prototype.refreshBusinessData = function (callback, isRecord) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5QQ.prototype.dispatchBusinessWindowsQueue = function () {
        return __awaiter(this, void 0, void 0, function () {
            var execute;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    // 商业化下单
    SdkH5QQ.prototype.requestBusinessOrder = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var result, err_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SdkH5QQ.prototype.clearPromoterTimer = function () {
    ...
    // 启动定时器
    SdkH5QQ.prototype.startPromoterTimer = function (callback, autoRefresh) {
        var _this = this;
    ...
    // 获取福利码
    SdkH5QQ.prototype.getPromoDisplayKEY = function (callback, autoRefresh, immediately) {
        var _this = this;
    ...
    // 兑换福利码
    SdkH5QQ.prototype.exchangePromoCDKEY = function (cdkey, callback) {
    ...
    SdkH5QQ.prototype.checkIsPromoter = function () {
        return this.is_promoter;
    };
    return SdkH5QQ;
}(SdkCommon_1.default));
exports.default = SdkH5QQ;
//# sourceMappingURL=index.h5_qiqi.js.map