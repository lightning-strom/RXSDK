...
function findSDK(maxDepth) {
    ...
    while (currentWindow && depth < maxDepth) {
        // 检查当前窗口是否存在 lenovocp 对象
        if (currentWindow.lenovocp) {
            return currentWindow.lenovocp;
        }
...
// 使用示例
var lenovocp = findSDK();
if (lenovocp) {
    console.info('找到 lenovocp 对象:', lenovocp);
}
else {
    console.info('未找到 lenovocp 对象');
}
var SdkH5Lenovo = /** @class */ (function (_super) {
    __extends(SdkH5Lenovo, _super);
    function SdkH5Lenovo(initParams) {
        ...
        // 初始化必要参数
        _this.mandatoryParams = ['game', 'token', 'failUrl', 'lpms'];
        // 初始化选填参数
        _this.optionalParams = ['serviceId'];
        // 初始化url参数
        _this.initUrlParams = {};
        _this.openId = '';
    ...
    // 登录
    SdkH5Lenovo.prototype.login = function (params, callback) {
        var _a, _b, _c, _d;
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        requestParams = __assign({ ts: now, method: params.method || 'minigame_lenovo', distinct_id: distinct_id, ext: params.ext }, user_source);
                        try {
    ...
    // 支付
    SdkH5Lenovo.prototype.pay = function (params, callback) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p;
        return __awaiter(this, void 0, void 0, function () {
            var reqOrder, result, urlParams, payUrl, err_2;
            return __generator(this, function (_q) {
                switch (_q.label) {
                    case 0:
                        _q.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.H5LenovoPayCheckParams, callback, params)];
                    case 1:
                        _q.sent();
                        if (params.indulge_auth == 1 && !params.age) {
                            throw Error('when indulge_auth equal 1,the age must be required');
                        }
                        reqOrder = __assign(__assign(__assign(__assign({}, params), { currency: params.currency || 'CNY', sub_channel_id: config_1.USER_INFO === null || config_1.USER_INFO === void 0 ? void 0 : config_1.USER_INFO.subchannelid, is_debug: params.is_debug || 0, env: params.env || 0 }), this.initUrlParams), { openid: config_1.USER_INFO.openid });
                        return [4 /*yield*/, (0, apis_1.orderApi)(reqOrder)];
                    case 2:
                        result = _q.sent();
                        urlParams = "?partner=".concat((_b = (_a = result === null || result === void 0 ? void 0 : result.data) === null || _a === void 0 ? void 0 : _a.ext) === null || _b === void 0 ? void 0 : _b.partner, "&notifyUrl=").concat((_d = (_c = result === null || result === void 0 ? void 0 : result.data) === null || _c === void 0 ? void 0 : _c.ext) === null || _d === void 0 ? void 0 : _d.notifyUrl, "&outTradeNo=").concat((_f = (_e = result === null || result === void 0 ? void 0 : result.data) === null || _e === void 0 ? void 0 : _e.ext) === null || _f === void 0 ? void 0 : _f.outTradeNo, "&encLenovoId=").concat((_h = (_g = result === null || result === void 0 ? void 0 : result.data) === null || _g === void 0 ? void 0 : _g.ext) === null || _h === void 0 ? void 0 : _h.encLenovoId, "&gameId=").concat((_k = (_j = result === null || result === void 0 ? void 0 : result.data) === null || _j === void 0 ? void 0 : _j.ext) === null || _k === void 0 ? void 0 : _k.gameId, "&extraCommonParam=").concat(params === null || params === void 0 ? void 0 : params.extraCommonParam, "&server=").concat(params === null || params === void 0 ? void 0 : params.server, "&role=").concat(params === null || params === void 0 ? void 0 : params.role, "&lpms=").concat((_m = (_l = result === null || result === void 0 ? void 0 : result.data) === null || _l === void 0 ? void 0 : _l.ext) === null || _m === void 0 ? void 0 : _m.lpms, "&totalFee=").concat((_p = (_o = result === null || result === void 0 ? void 0 : result.data) === null || _o === void 0 ? void 0 : _o.ext) === null || _p === void 0 ? void 0 : _p.totalFee);
                        payUrl = 'https://cp.vgs.lenovo.com.cn/h5pay';
                        lenovocp.pay({
                            url: payUrl + urlParams,
                            type: 'h5', // 默认pc pc,h5
                        }).then(function (res) {
                            //创单成功
                            console.log(res);
                            ...
                            console.log('创单失败', err);
                            callback.complete((0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_pay', err));
                        });
                        return [3 /*break*/, 4];
                    case 3:
                        err_2 = _q.sent();
    ...
    SdkH5Lenovo.prototype.schedulingAction = function (params, callback) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
    ...
    //获得分享内容
    SdkH5Lenovo.prototype.getAdShareData = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Lenovo.prototype.setScheuleReportProps = function (data) {
    ...
    // 获得公共属性
    SdkH5Lenovo.prototype.getPublicProperties = function () {
     ...
     */
    SdkH5Lenovo.prototype.setPublicProperties = function (params) {
     ...
     * 修改设置的公共数据。
     */
    SdkH5Lenovo.prototype.updatePublicProperties = function (params) {
        if (!(0, is_1.isObject)(params)) {
            var error = new Error('params must be object');
            error.code = const_1.COMMON_ERROR_CODE.PAY_PARAMS_ERROR;
            return (0, utils_2.handleTrackError)(PLATFORM, '', error);
     ...
     * 删除公共属性
     */
    SdkH5Lenovo.prototype.deletePublicProperties = function (params) {
        try {
            var cache = (0, utils_2.customGetStorageSync)('rx_public_props');
            // @ts-ignore
    ...
    //获得分享内容
    SdkH5Lenovo.prototype.getShareData = function (params, callback, stopCallback) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    // 获取埋点调度
    SdkH5Lenovo.prototype.getShareScheduling = function (params) {
    ...
    // 分享调度初始化
    SdkH5Lenovo.prototype.shareSchedulingInit = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var req, res, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    // 看广告完成上报
    SdkH5Lenovo.prototype.shareSchedulingReport = function (params, callback) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Lenovo.prototype.getInitConfig = function (callback) {
    ...
    SdkH5Lenovo.prototype.publicSubchannelCheck = function (res) {
        var _a, _b;
        try {
    ...
    // 获取归因数据
    SdkH5Lenovo.prototype.getAttributionData = function () {
    ...
    SdkH5Lenovo.prototype.checkNeedActivate = function () {
        return __awaiter(this, void 0, void 0, function () {
     ...
     *
     */
    SdkH5Lenovo.prototype.loopGetPublicProps = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
    ...
    //格式化queryString
    SdkH5Lenovo.prototype.getLoginQsAndGenerateStruct = function () {
        var _a;
        var universal = (0, utils_2.getSearchQueries)();
        var user_source = {};
    ...
    SdkH5Lenovo.prototype.ActivePrefix = function (reqParams) {
     ...
     */
    SdkH5Lenovo.prototype.setSubChannelId = function (subChannelId) {
        try {
    ...
    SdkH5Lenovo.prototype.loadScript = function (url) {
    ...
    //商业广告
    SdkH5Lenovo.prototype.getAllBusinessData = function (callback) {
        return __awaiter(this, void 0, void 0, function () {
            var data, result;
            return __generator(this, function (_a) {
                try {
    ...
    // 条件获取商业化窗口数据
    SdkH5Lenovo.prototype.getBusinessData = function (params, callback) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
    ...
    // 更新商业化窗口数据
    SdkH5Lenovo.prototype.refreshBusinessData = function (callback, isRecord) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SdkH5Lenovo.prototype.dispatchBusinessWindowsQueue = function () {
        return __awaiter(this, void 0, void 0, function () {
            var execute;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    // 商业化下单
    SdkH5Lenovo.prototype.requestBusinessOrder = function (params, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var result, err_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SdkH5Lenovo.prototype.clearPromoterTimer = function () {
    ...
    // 启动定时器
    SdkH5Lenovo.prototype.startPromoterTimer = function (callback, autoRefresh) {
        var _this = this;
    ...
    // 获取福利码
    SdkH5Lenovo.prototype.getPromoDisplayKEY = function (callback, autoRefresh, immediately) {
        var _this = this;
    ...
    // 兑换福利码
    SdkH5Lenovo.prototype.exchangePromoCDKEY = function (cdkey, callback) {
    ...
    SdkH5Lenovo.prototype.checkIsPromoter = function () {
        return this.is_promoter;
    };
    return SdkH5Lenovo;
}(SdkCommon_1.default));
exports.default = SdkH5Lenovo;
//# sourceMappingURL=index.h5_lenovo.js.map