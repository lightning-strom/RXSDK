...
var SdkBilibili = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(bl.getUserInfo, {})];
                    case 1:
                        userInfoResult = _a.sent();
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(bl.login, {})];
                    case 2:
                        loginResult = _a.sent();
    ...
    SdkBilibili.prototype.login = function (params, callback) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user_source, source_ad, distinct_idLocal, distinct_id, now, reqLogin, queryJson, userInfoResult, loginResult, e_1, _g, custom_ext, rest_ext, loginTokenRx, reflowEnabled, loginRx, err_1;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        _h.trys.push([0, 11, , 12]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.bilibiliLoginParamsCheck, callback, params)];
                    case 1:
                        _h.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_x) {
                switch (_x.label) {
                    ...
                    case 1:
                        _x.trys.push([1, 5, , 6]);
                        return [4 /*yield*/, (0, paramsValid_1.pubCheck)(checkConfig_1.bilibiliPayCheckParams, callback, params)];
                    case 2:
                        _x.sent();
                    ...
                    case 3:
                        result = _x.sent();
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(bl.requestRecharge, {
                    ...
                    case 2:
                        ...
                        this._rewardedVideoAd.show().catch(function () {
                            ...
                            _this._rewardedVideoAd.load()
                                ...
                                var error = (0, utils_2.handleTrackError)(PLATFORM, 'rxlog_error_ad', err);
                                complete(error);
                                fail && fail(error);
                            });
                        });
                    ...
                    success: function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 2:
                                    err_5 = _a.sent();
                                    complete((0, utils_2.handleTrackError)(PLATFORM, '', err_5));
                                    return [3 /*break*/, 3];
                                case 3: return [2 /*return*/];
                            }
                        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(bl.getSetting)];
                    case 2:
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(bl.authorize, { scope: scope })];
                    case 4:
                        // undefined 代表用户未授权且第一次登陆
                        _a.sent();
                        (callback === null || callback === void 0 ? void 0 : callback.complete) && callback.complete({ code: 0 });
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(bl.showModal, {
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, (0, utils_1.asyncFunc)(bl.openSetting)];
                    case 8:
                        openSetting = _a.sent();
                    ...
                    case 11:
                        err_6 = _a.sent();
                        (callback === null || callback === void 0 ? void 0 : callback.complete) && callback.complete((0, utils_2.handleTrackError)(PLATFORM, '', err_6));
                        return [2 /*return*/, false];
                    case 12: return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 2:
                        ...
                        (0, stOffset_1.setupStOffsetRefreshForMiniGame)(typeof bl !== 'undefined' ? bl : null, apis_1.getServerTime);
                        // 检查是否需要激活
...
exports.default = SdkBilibili;
//# sourceMappingURL=index.bilibili.js.map