...
var feedback_1 = require("@/api/huawei/feedback");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, (0, feedback_1.getFeedbackApi)()];
                    case 1:
                        result = _b.sent();
                        complete(result);
                        return [3 /*break*/, 3];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, (0, feedback_1.createFeedbackApi)(__assign(__assign({}, params), { product_id: config_1.SYSTEM_INFO.productId, channel_id: config_1.SYSTEM_INFO.channelId }))];
                    case 1:
                        result = _b.sent();
                        complete(result);
                        return [3 /*break*/, 3];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, (0, feedback_1.feedbackEvalApi)(params)];
                    case 1:
                        result = _b.sent();
                        complete(result);
                        return [3 /*break*/, 3];
...
exports.default = SdkFeedback;
//# sourceMappingURL=index.feedback.js.map