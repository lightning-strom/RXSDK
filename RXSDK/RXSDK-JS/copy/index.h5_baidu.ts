...
const PLATFORM = 'minigame_baiduh5'
...
class SdkH5Baidu extends SdkCommon {
  ...
  constructor(initParams: InitH5Params) {
    ...
    if (window.QQSY_SDK) {
      ...
      this.loadScript(`https://h5sdk.cdqcwl.com/static/sdk/channel_js_sdk/baidu.js`)
        .then(() => {
          this.getInitConfig({ complete: initParams.complete })
        })
        .catch((err: any) => {
  ...
  private async login(params: H5BaiduLoginParam, callback: H5MethodParams) {
    try {
      ...
      const requestParams: any = {
        ts: now,
        method: params.method || 'minigame_baiduh5',
        distinct_id,
        ext: params.ext,
        ...user_source
      }
  ...
  public async pay(params: H5BaiduPayParam, callback: H5MethodParams) {
    try {
